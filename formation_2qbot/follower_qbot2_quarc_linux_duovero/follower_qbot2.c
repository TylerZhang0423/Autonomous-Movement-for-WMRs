...
/* Function for MATLAB Function: '<S21>/Way Point Control' */
static void follower__ClosedLoop_Sequential(real_T dist, real_T theta, real_T
  vlimit, real_T ang_thr, real_T Kv, real_T Kw, real_T Vf_1, real_T *Vf, real_T *
  W)
{
...
void follower_qbot2_step(void)
{
  ...
  real_T states;
  real_T rtheta;
  boolean_T rtb_Relation_b;
  boolean_T rtb_Relation;
  real_T rtb_Product2;
  real_T rtb_Gain1;
  int8_T rtAction;
  real_T rtb_ManualSwitchTrackingMethod1;
  ...
  /* Reset subsysRan breadcrumbs */
  srClearBC(follower_qbot2_DW.SwitchCaseActionSubsystem_Subsy);
  ...
  if (rtmIsMajorTimeStep(follower_qbot2_M)) {
    ...
    /* S-Function Block: follower_qbot2/Data From Host1/Stream Client (stream_client_block) */
    {
    ...
    /* Constant: '<S1>/Dummy' */
    follower_qbot2_B.Dummy = follower_qbot2_P.Dummy_Value;
    ...
    rtb_Relation_b = ((follower_qbot2_B.StreamClient_o3[5] != 0.0) ||
     ...
     */
    if (rtb_Relation_b) {
      follower_qbot2_B.Switch[0] = follower_qbot2_B.StreamClient_o3[0];
      follower_qbot2_B.Switch[1] = follower_qbot2_B.Dummy;
      follower_qbot2_B.Switch[2] = follower_qbot2_B.StreamClient_o3[1];
      follower_qbot2_B.Switch1[0] = follower_qbot2_B.StreamClient_o3[2];
      follower_qbot2_B.Switch1[1] = follower_qbot2_B.StreamClient_o3[3];
      follower_qbot2_B.Switch1[2] = follower_qbot2_B.StreamClient_o3[4];
    } else {
     ...
     */
    rtb_Relation_b = (follower_qbot2_B.StreamClient_o3[5] <
                      follower_qbot2_P.SignalThreshold_Value);

    /* Logic: '<S7>/Logical Operator' */
    rtb_LogicalOperator = !rtb_Relation_b;
     ...
     *  Constant: '<S2>/Signal Threshold'
     */
    rtb_Relation = (follower_qbot2_B.DataTypeConversion <
                    follower_qbot2_P.SignalThreshold_Value);

    /* Logic: '<S8>/Logical Operator' */
    rtb_LogicalOperator_k = !rtb_Relation;
    ...
    if (rtb_LogicalOperator_k ||
      ...
      follower_qbot2_DW.DiscreteTimeIntegrator_DSTATE_j =
        follower_qbot2_P.DiscreteTimeIntegrator_IC_o;
    }
     ...
     *  DiscreteIntegrator: '<S8>/Discrete-Time Integrator'
     */
    follower_qbot2_B.RelationalOperator_n =
      (follower_qbot2_DW.DiscreteTimeIntegrator_DSTATE_j >=
       follower_qbot2_P.TimeoutThresholds_Value);
    ...
    /* Outputs for Atomic SubSystem: '<S9>/Bias Removal' */
    /* Step: '<S11>/Step: start_time' */
    currentTime = (((follower_qbot2_M->Timing.clockTick1+
                     follower_qbot2_M->Timing.clockTickH1* 4294967296.0)) *
                   0.002);
    if (currentTime < follower_qbot2_P.BiasRemoval_start_time) {
      currentTime = follower_qbot2_P.Stepstart_time_Y0;
    } else {
      currentTime = follower_qbot2_P.Stepstart_time_YFinal;
    }
    ...
    if ((((follower_qbot2_M->Timing.clockTick1+
      ...
      rtb_target_xy_idx_0 = follower_qbot2_P.Stepend_time_Y0;
    } else {
      rtb_target_xy_idx_0 = follower_qbot2_P.Stepend_time_YFinal;
    }
    ...
    if ((currentTime != 0.0) && (!(rtb_target_xy_idx_0 != 0.0))) {
       ...
       */
      follower_qbot2_DW.UnitDelay_DSTATE += follower_qbot2_P.unity_Value;

      /* Update for UnitDelay: '<S13>/Sum( k=1,n-1, x(k) )' incorporates:
       *  Sum: '<S13>/Sum'
    ...
    if (follower_qbot2_P.BiasRemoval_switch_id < 0.0) {
      rtb_target_xy_idx_0 = ceil(follower_qbot2_P.BiasRemoval_switch_id);
    } else {
      rtb_target_xy_idx_0 = floor(follower_qbot2_P.BiasRemoval_switch_id);
    }
    ...
    /* End of Outputs for SubSystem: '<S9>/Bias Removal' */
  ...
  if (rtmIsMajorTimeStep(follower_qbot2_M)) {
    /* ManualSwitch: '<Root>/Manual Switch - QBot 2 Enable1' incorporates:
     *  Constant: '<Root>/Disable1'
     *  Constant: '<Root>/Enable1'
     */
    if (follower_qbot2_P.ManualSwitchQBot2Enable1_Curren == 1) {
      follower_qbot2_B.ManualSwitchQBot2Enable1 = follower_qbot2_P.Enable1_Value;
    } else {
      follower_qbot2_B.ManualSwitchQBot2Enable1 =
        follower_qbot2_P.Disable1_Value;
    }

    /* End of ManualSwitch: '<Root>/Manual Switch - QBot 2 Enable1' */
  }

  /* Product: '<Root>/Product2' */
  rtb_Product2 = rtb_Integrator1 * follower_qbot2_B.ManualSwitchQBot2Enable1 *
    follower_qbot2_B.StreamClient_o3[5];

  /* RateLimiter: '<S3>/Rate Limiter - Linear Speed' */
  if (follower_qbot2_DW.LastMajorTime == (rtInf)) {
    follower_qbot2_B.RateLimiterLinearSpeed = rtb_Product2;
  } else {
    currentTime = follower_qbot2_M->Timing.t[0] -
      follower_qbot2_DW.LastMajorTime;
    rtheta = currentTime * follower_qbot2_P.RateLimiterLinearSpeed_RisingLi;
    rtb_target_xy_idx_0 = rtb_Product2 - follower_qbot2_DW.PrevY;
    if (rtb_target_xy_idx_0 > rtheta) {
      follower_qbot2_B.RateLimiterLinearSpeed = follower_qbot2_DW.PrevY + rtheta;
    } else {
      currentTime *= follower_qbot2_P.RateLimiterLinearSpeed_FallingL;
  ...
  if (rtmIsMajorTimeStep(follower_qbot2_M)) {
    /* Constant: '<S20>/x0' */
    follower_qbot2_B.x0_h = follower_qbot2_P.x0_Value_h;
  }

  /* Integrator: '<S20>/Integrator1' */
  if (follower_qbot2_DW.Integrator1_IWORK_l.IcNeedsLoading) {
    follower_qbot2_X.Integrator1_CSTATE_b = follower_qbot2_B.x0_h;
  }

  rtb_Integrator1_l = follower_qbot2_X.Integrator1_CSTATE_b;

  /* Product: '<Root>/Product3' */
  rtb_Product2 = rtb_Integrator1_l * follower_qbot2_B.ManualSwitchQBot2Enable1 *
    follower_qbot2_B.StreamClient_o3[5];

  /* RateLimiter: '<S3>/Rate Limiter - Rotation Rate' */
  if (follower_qbot2_DW.LastMajorTime_a == (rtInf)) {
    follower_qbot2_B.RateLimiterRotationRate = rtb_Product2;
  } else {
    currentTime = follower_qbot2_M->Timing.t[0] -
      follower_qbot2_DW.LastMajorTime_a;
    rtheta = currentTime * follower_qbot2_P.RateLimiterRotationRate_RisingL;
    rtb_target_xy_idx_0 = rtb_Product2 - follower_qbot2_DW.PrevY_d;
    if (rtb_target_xy_idx_0 > rtheta) {
      follower_qbot2_B.RateLimiterRotationRate = follower_qbot2_DW.PrevY_d +
        rtheta;
    } else {
      currentTime *= follower_qbot2_P.RateLimiterRotationRate_Falling;
      if (rtb_target_xy_idx_0 < currentTime) {
        follower_qbot2_B.RateLimiterRotationRate = follower_qbot2_DW.PrevY_d +
          currentTime;
      } else {
  ...
  /* MATLAB Function: '<S10>/Qbot2_Inverse_Kinematics  (Forward Velocity and Angular Velocity into Left and Right Wheel Vellocity)' */
  /* MATLAB Function 'QBot 2/Qbot2_Inverse_Kinematics  (Forward Velocity and Angular Velocity  into Left and Right Wheel Vellocity)/Qbot2_Inverse_Kinematics  (Forward Velocity and Angular Velocity into Left and Right Wheel Vellocity)': '<S18>:1' */
  ...
  if (rtmIsMajorTimeStep(follower_qbot2_M)) {
    ...
    rtb_DataTypeConversion = rtb_Relation_b;

    /* DataTypeConversion: '<S8>/Data Type Conversion' */
    rtb_DataTypeConversion_l = rtb_Relation;

    /* Gain: '<Root>/Gain1' incorporates:
     *  Constant: '<Root>/V Limit5'
     */
    rtb_Gain1 = follower_qbot2_P.Gain1_Gain * follower_qbot2_P.VLimit5_Value;

    /* ManualSwitch: '<Root>/Manual Switch - Tracking Method1' incorporates:
     *  Constant: '<Root>/Sequential1'
     *  Constant: '<Root>/Simultaneous1'
     */
    if (follower_qbot2_P.ManualSwitchTrackingMethod1_Cur == 1) {
      rtb_ManualSwitchTrackingMethod1 = follower_qbot2_P.Sequential1_Value;
    } else {
      rtb_ManualSwitchTrackingMethod1 = follower_qbot2_P.Simultaneous1_Value;
    }

    /* End of ManualSwitch: '<Root>/Manual Switch - Tracking Method1' */
  }

  if (rtmIsMajorTimeStep(follower_qbot2_M)) {
    /* MATLAB Function: '<S21>/Way Point Control' incorporates:
     *  Constant: '<Root>/V Limit3'
     *  Constant: '<Root>/V Limit4'
     *  Constant: '<S5>/Kv_1'
     *  Constant: '<S5>/Kv_2'
     *  Constant: '<S5>/Kv_3'
     *  Constant: '<S5>/Kv_4'
     *  Constant: '<S5>/Waypoint Step'
     *  Memory: '<S21>/Memory'
     *  SignalConversion: '<S22>/TmpSignal ConversionAt SFunction Inport1'
     *  SignalConversion: '<S22>/TmpSignal ConversionAt SFunction Inport2'
     */
    /* MATLAB Function 'Waypoint Controller1/Trajectory control (Way-points)/Way Point Control': '<S22>:1' */
    ...
    /* '<S22>:1:19' */
    states = follower_qbot2_DW.Memory_PreviousInput_h;
    ...
    /* -------------------------------------------------------------------------- */
    /* '<S22>:1:105' */
    rtheta = follower_qbot2_B.Switch1[1];
    if (follower_qbot2_B.Switch1[1] > 3.1415926535897931) {
      /* '<S22>:1:106' */
      /* '<S22>:1:107' */
      rtheta = follower_qbot2_B.Switch1[1] - 6.2831853071795862;
    } else {
      if (follower_qbot2_B.Switch1[1] < -3.1415926535897931) {
        /* '<S22>:1:108' */
        /* '<S22>:1:109' */
    ...
    /* '<S22>:1:26' */
    rtb_target_xy_idx_0 = follower_qbot2_B.Switch1[2];
    rtb_target_xy_idx_1 = follower_qbot2_B.Switch1[0];

    /* '<S22>:1:27' */
    /* '<S22>:1:32' */
    if (follower_qbot2_DW.Memory_PreviousInput_h == 1.0) {
      /* '<S22>:1:33' */
      /* '<S22>:1:34' */
      /* '<S22>:1:35' */
      rtb_target_xy_idx_0 = follower_qbot2_B.Switch[2];

      /* '<S22>:1:34' */
      /* '<S22>:1:35' */
      rtb_target_xy_idx_1 = follower_qbot2_B.Switch[0];
    ...
    /*  ------------------------------------------------------------------------- */
    /* '<S22>:1:114' */
    currentTime = follower_qbot2_B.Switch1[2] - rtb_target_xy_idx_0;
    rtb_Product2 = follower_qbot2_B.Switch1[0] - rtb_target_xy_idx_1;
    target_distance = sqrt(currentTime * currentTime + rtb_Product2 *
      rtb_Product2);
    ...
    rtb_target_xy_idx_0 = rt_atan2d_snf(rtb_target_xy_idx_1 -
      follower_qbot2_B.Switch1[0], rtb_target_xy_idx_0 -
      follower_qbot2_B.Switch1[2]);
    ...
    if ((follower_qbot2_DW.Memory_PreviousInput_h == 1.0) && (target_distance <=
         follower_qbot2_P.VLimit4_Value)) {
      /* '<S22>:1:46' */
      /* || states(1) == -1 */
      /*  %        states(1) = -1; */
      /*  right_vel = int16(0); */
      ...
      if ((follower_qbot2_DW.end_flag == 1.0) && (target_distance <=
        ...
        /* -------------------------------------------------------------------------- */
        /* '<S22>:1:105' */
        currentTime = follower_qbot2_B.Switch[1];
        if (follower_qbot2_B.Switch[1] > 3.1415926535897931) {
          /* '<S22>:1:106' */
          /* '<S22>:1:107' */
          currentTime = follower_qbot2_B.Switch[1] - 6.2831853071795862;
        } else {
          if (follower_qbot2_B.Switch[1] < -3.1415926535897931) {
            /* '<S22>:1:108' */
            /* '<S22>:1:109' */
        ...
        follower__ClosedLoop_Sequential(0.0, currentTime,
          follower_qbot2_P.VLimit3_Value, rtb_Gain1, follower_qbot2_P.Kv_1_Value,
          follower_qbot2_P.Kv_2_Value, follower_qbot2_DW.Vf_1, &rtb_Product2,
          &rtheta);

        /* '<S22>:1:55' */
        follower_qbot2_B.Vf = rtb_Product2;

        /* '<S22>:1:55' */
        follower_qbot2_B.W = rtheta;

        /* '<S22>:1:56' */
        follower_qbot2_DW.Vf_1 = rtb_Product2;
      }
    } else if ((target_distance <= follower_qbot2_P.VLimit4_Value) &&
      ...
      /* 1; */
      if (follower_qbot2_DW.Memory_PreviousInput_h > 0.0) {
        /* '<S22>:1:65' */
        while ((fabs(follower_qbot2_B.Switch[2] - follower_qbot2_B.Switch[2]) <
                2.0 * follower_qbot2_P.VLimit4_Value) && (fabs
                (follower_qbot2_B.Switch[0] - follower_qbot2_B.Switch[0]) < 2.0 *
                follower_qbot2_P.VLimit4_Value)) {
          /* '<S22>:1:66' */
      ...
      /*            Vf_1=Vf; */
    } else if (rtb_ManualSwitchTrackingMethod1 == 2.0) {
      /* '<S22>:1:89' */
      /*  ------------------------------------------------------------------------- */
      /* '<S22>:1:131' */
      rtheta = 2.0 * follower_qbot2_P.VLimit3_Value;

      /* '<S22>:1:132' */
      rtb_Product2 = follower_qbot2_P.Kv_4_Value * rtb_target_xy_idx_0;

      /* if abs(theta)<pi */
      /* '<S22>:1:135' */
      currentTime = follower_qbot2_P.Kv_3_Value * target_distance;

      /* else */
      /*     Vf=0; */
      /* end */
      /* '<S22>:1:140' */
      if (fabs(rtb_Product2) > rtheta) {
        /* '<S22>:1:141' */
        /* '<S22>:1:142' */
        if (rtb_Product2 < 0.0) {
          rtb_Product2 = -1.0;
      ...
      if (fabs(currentTime) > follower_qbot2_P.VLimit3_Value) {
        /* '<S22>:1:144' */
        /* '<S22>:1:145' */
        currentTime = fabs(currentTime) * follower_qbot2_P.VLimit3_Value;
      }

      /* '<S22>:1:90' */
      follower_qbot2_B.Vf = currentTime;

      /* '<S22>:1:90' */
      follower_qbot2_B.W = rtb_Product2;
    } else {
      /*             [right_vel, left_vel] = rotate_and_go(ang_to_tar, vlimit, ang_thr); */
      follower__ClosedLoop_Sequential(target_distance, rtb_target_xy_idx_0,
        follower_qbot2_P.VLimit3_Value, rtb_Gain1, follower_qbot2_P.Kv_1_Value,
        follower_qbot2_P.Kv_2_Value, follower_qbot2_DW.Vf_1, &currentTime,
        &rtb_Product2);
      ...
      /* '<S22>:1:94' */
      follower_qbot2_DW.Vf_1 = currentTime;
    }

    rtb_states = states;

    /* End of MATLAB Function: '<S21>/Way Point Control' */
  }
  ...
  follower_qbot2_B.Product = ((follower_qbot2_B.Vf - rtb_Integrator1) -
    follower_qbot2_X.Integrator2_CSTATE * follower_qbot2_P.Constant_Value *
    follower_qbot2_P.SecondOrderLowPassFilter1_inp_c) *
   ...
   *  Sum: '<S20>/Sum1'
   */
  follower_qbot2_B.Product_o = ((follower_qbot2_B.W - rtb_Integrator1_l) -
    follower_qbot2_X.Integrator2_CSTATE_j * follower_qbot2_P.Constant_Value_k *
    follower_qbot2_P.SecondOrderLowPassFilter4_inp_c) *
   ...
   *  Integrator: '<S20>/Integrator2'
   */
  follower_qbot2_B.Product1_h = follower_qbot2_P.SecondOrderLowPassFilter4_input
    * follower_qbot2_X.Integrator2_CSTATE_j;
  if (rtmIsMajorTimeStep(follower_qbot2_M)) {
    if (rtmIsMajorTimeStep(follower_qbot2_M)) {
      ...
      if (!rtb_LogicalOperator_k) {
        follower_qbot2_DW.DiscreteTimeIntegrator_DSTATE_j +=
          follower_qbot2_P.DiscreteTimeIntegrator_gainva_p *
    ...
    follower_qbot2_DW.Integrator1_IWORK_l.IcNeedsLoading = 0;

    /* Update for RateLimiter: '<S3>/Rate Limiter - Rotation Rate' */
    follower_qbot2_DW.PrevY_d = follower_qbot2_B.RateLimiterRotationRate;
    follower_qbot2_DW.LastMajorTime_a = follower_qbot2_M->Timing.t[0];
    if (rtmIsMajorTimeStep(follower_qbot2_M)) {
      /* Update for Memory: '<S21>/Memory' */
      follower_qbot2_DW.Memory_PreviousInput_h = rtb_states;
    }
...
void follower_qbot2_derivatives(void)
{
  ...
  {
    ((XDot_follower_qbot2_T *) follower_qbot2_M->ModelData.derivs)
      ->Integrator1_CSTATE_b = follower_qbot2_B.Product1_h;
  }
  ...
  _rtXdot->Integrator2_CSTATE_j = follower_qbot2_B.Product_o;
}
...
void follower_qbot2_initialize(void)
{
  ...
  /* External mode info */
  follower_qbot2_M->Sizes.checksums[0] = (3370202634U);
  follower_qbot2_M->Sizes.checksums[1] = (163234165U);
  follower_qbot2_M->Sizes.checksums[2] = (2074273001U);
  follower_qbot2_M->Sizes.checksums[3] = (1265182206U);

  {
    ...
    systemRan[2] = (sysRanDType *)
      &follower_qbot2_DW.SwitchCaseActionSubsystem_Subsy;
  ...
  /* S-Function Block: follower_qbot2/Data From Host1/Stream Client (stream_client_block) */
  {
    ...
    {
      int_T i1;
      real_T *y2 = &follower_qbot2_B.StreamClient_o3[0];
  ...
  /* Start for Atomic SubSystem: '<S9>/Bias Removal' */
  /* Start for Enabled SubSystem: '<S11>/Enabled Moving Average' */
  follower_qbot2_DW.EnabledMovingAverage_MODE = false;

  /* End of Start for SubSystem: '<S11>/Enabled Moving Average' */

  /* InitializeConditions for Enabled SubSystem: '<S11>/Enabled Moving Average' */
  /* InitializeConditions for UnitDelay: '<S17>/Unit Delay' */
  follower_qbot2_DW.UnitDelay_DSTATE =
    follower_qbot2_P.UnitDelay_InitialCondition;
  ...
  /* End of InitializeConditions for SubSystem: '<S11>/Enabled Moving Average' */

  /* Start for SwitchCase: '<S11>/Switch Case' */
  follower_qbot2_DW.SwitchCase_ActiveSubsystem = -1;

  /* End of Start for SubSystem: '<S9>/Bias Removal' */

  /* Start for Constant: '<S19>/x0' */
  follower_qbot2_B.x0 = follower_qbot2_P.x0_Value;
  ...
  if (rtmIsFirstInitCond(follower_qbot2_M)) {
    follower_qbot2_X.Integrator1_CSTATE_b = 0.0;
  }

  follower_qbot2_DW.Integrator1_IWORK_l.IcNeedsLoading = 1;

  /* InitializeConditions for RateLimiter: '<S3>/Rate Limiter - Rotation Rate' */
  follower_qbot2_DW.LastMajorTime_a = (rtInf);
  ...
  follower_qbot2_DW.Memory_PreviousInput_h = follower_qbot2_P.Memory_X0_p;

  /* InitializeConditions for MATLAB Function: '<S21>/Way Point Control' */
  follower_qbot2_DW.Vf_1 = 0.0;
  follower_qbot2_DW.end_flag = 0.0;

  /* InitializeConditions for Integrator: '<S20>/Integrator2' */
  follower_qbot2_X.Integrator2_CSTATE_j = follower_qbot2_P.Integrator2_IC_a;
