...
P_follower_qbot2_T follower_qbot2_P = {
  ...
  1.0,                                 /* Mask Parameter: SecondOrderLowPassFilter1_inp_c
                                        ...
                                        */
  1.0,                                 /* Mask Parameter: SecondOrderLowPassFilter4_inp_c
  ...
  1U,                                  /* Computed Parameter: StreamClient_Endian
                                        * Referenced by: '<S1>/Stream Client'
                                        */
  1U,                                  /* Computed Parameter: ManualSwitchQBot2Enable1_Curren
                                        * Referenced by: '<Root>/Manual Switch - QBot 2 Enable1'
                                        */
  1U,                                  /* Computed Parameter: ManualSwitchTrackingMethod1_Cur
