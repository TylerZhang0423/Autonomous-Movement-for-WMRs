  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% follower_qbot2_P.Enable1_Value
	  ...
	  ;% follower_qbot2_P.VLimit5_Value
	  section.data(28).logicalSrcIdx = 103;
	  section.data(28).dtTransOffset = 27;
	
	  ;% follower_qbot2_P.Gain1_Gain
	  section.data(29).logicalSrcIdx = 104;
	  section.data(29).dtTransOffset = 28;
	
	  ;% follower_qbot2_P.Sequential1_Value
	  section.data(30).logicalSrcIdx = 105;
	  section.data(30).dtTransOffset = 29;
	
	  ;% follower_qbot2_P.Simultaneous1_Value
	  section.data(31).logicalSrcIdx = 106;
	  section.data(31).dtTransOffset = 30;
	
	  ;% follower_qbot2_P.VLimit3_Value
	  ...
	  ;% follower_qbot2_P.Memory_X0_p
	  section.data(41).logicalSrcIdx = 116;
	  section.data(41).dtTransOffset = 40;
	
	  ;% follower_qbot2_P.Constant_Value_k
	  section.data(42).logicalSrcIdx = 117;
	  section.data(42).dtTransOffset = 41;
	
	  ;% follower_qbot2_P.Integrator2_IC_a
	  ...
	  ;% follower_qbot2_P.ManualSwitchQBot2Enable1_Curren
	  section.data(4).logicalSrcIdx = 130;
	  section.data(4).dtTransOffset = 82;
	
	  ;% follower_qbot2_P.ManualSwitchTrackingMethod1_Cur
  ...
  ;%**************************
    ...
    ;%
	  ...
	  ;% follower_qbot2_B.Product_o
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 21;
	
	  ;% follower_qbot2_B.Product1_h
	  section.data(14).logicalSrcIdx = 13;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% follower_qbot2_DW.Memory_PreviousInput_h
	  section.data(18).logicalSrcIdx = 17;
	  ...
	  ;% follower_qbot2_DW.Integrator1_IWORK_l.IcNeedsLoading
  ...
  targMap.checksum0 = 3370202634;
  targMap.checksum1 = 163234165;
  targMap.checksum2 = 2074273001;
  targMap.checksum3 = 1265182206;
