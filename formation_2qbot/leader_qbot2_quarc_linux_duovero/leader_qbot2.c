...
void leader_qbot2_step(void)
{
  ...
  if (rtmIsMajorTimeStep(leader_qbot2_M)) {
    ...
    if (rtb_LogicalOperator_o) {
      ...
      leader_qbot2_B.Switch[0] = leader_qbot2_DW.Memory_PreviousInput[0];
      leader_qbot2_B.Switch[1] = leader_qbot2_DW.Memory_PreviousInput[1];
      leader_qbot2_B.Switch[2] = leader_qbot2_DW.Memory_PreviousInput[2];
      leader_qbot2_B.Switch1[0] = leader_qbot2_DW.Memory1_PreviousInput[0];
      leader_qbot2_B.Switch1[1] = leader_qbot2_DW.Memory1_PreviousInput[1];
      leader_qbot2_B.Switch1[2] = leader_qbot2_DW.Memory1_PreviousInput[2];
    }
  ...
  if (rtmIsMajorTimeStep(leader_qbot2_M)) {
     ...
     */
    /* MATLAB Function 'Waypoint Controller/Trajectory control (Way-points)/Way Point Control': '<S22>:1' */
...
void leader_qbot2_initialize(void)
{
  ...
  /* External mode info */
  leader_qbot2_M->Sizes.checksums[0] = (814617058U);
  leader_qbot2_M->Sizes.checksums[1] = (2174810171U);
  leader_qbot2_M->Sizes.checksums[2] = (300654366U);
  leader_qbot2_M->Sizes.checksums[3] = (3284346697U);
