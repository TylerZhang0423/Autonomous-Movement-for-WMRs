...
typedef struct {
  ...
  real_T Product_k;                    /* '<S20>/Product' */
  real_T Product1_j;                   /* '<S20>/Product1' */
  ...
  boolean_T RelationalOperator_b;      /* '<S8>/Relational Operator' */
...
typedef struct {
  ...
  real_T Memory_PreviousInput_e;       /* '<S21>/Memory' */
  ...
  struct {
    int_T IcNeedsLoading;
  } Integrator1_IWORK_p;               /* '<S20>/Integrator1' */
...
typedef struct {
  ...
  real_T Integrator1_CSTATE_l;         /* '<S20>/Integrator1' */
  real_T Integrator2_CSTATE;           /* '<S19>/Integrator2' */
  real_T Integrator2_CSTATE_e;         /* '<S20>/Integrator2' */
} X_leader_qbot2_T;
...
typedef struct {
  ...
  boolean_T Integrator1_CSTATE_l;      /* '<S20>/Integrator1' */
  boolean_T Integrator2_CSTATE;        /* '<S19>/Integrator2' */
  boolean_T Integrator2_CSTATE_e;      /* '<S20>/Integrator2' */
} XDis_leader_qbot2_T;
 ...
 * '<S4>'   : 'leader_qbot2/URI Definitions'
 * '<S5>'   : 'leader_qbot2/Waypoint Controller'
 * '<S6>'   : 'leader_qbot2/Data From Host/Compare To Constant'
 * '<S7>'   : 'leader_qbot2/Error Monitoring/Threshold'
 * '<S8>'   : 'leader_qbot2/Error Monitoring/Threshold1'
 * '<S9>'   : 'leader_qbot2/QBot 2/QBot_Basic'
 * '<S10>'  : 'leader_qbot2/QBot 2/Qbot2_Inverse_Kinematics  (Forward Velocity and Angular Velocity  into Left and Right Wheel Vellocity)'
 * '<S11>'  : 'leader_qbot2/QBot 2/QBot_Basic/Bias Removal'
 * '<S12>'  : 'leader_qbot2/QBot 2/QBot_Basic/QBot2_IO_Basic'
 * '<S13>'  : 'leader_qbot2/QBot 2/QBot_Basic/Bias Removal/Enabled Moving Average'
 * '<S14>'  : 'leader_qbot2/QBot 2/QBot_Basic/Bias Removal/Switch Case Action Subsystem'
 * '<S15>'  : 'leader_qbot2/QBot 2/QBot_Basic/Bias Removal/Switch Case Action Subsystem1'
 * '<S16>'  : 'leader_qbot2/QBot 2/QBot_Basic/Bias Removal/Switch Case Action Subsystem2'
 * '<S17>'  : 'leader_qbot2/QBot 2/QBot_Basic/Bias Removal/Enabled Moving Average/Increment'
 * '<S18>'  : 'leader_qbot2/QBot 2/Qbot2_Inverse_Kinematics  (Forward Velocity and Angular Velocity  into Left and Right Wheel Vellocity)/Qbot2_Inverse_Kinematics  (Forward Velocity and Angular Velocity into Left and Right Wheel Vellocity)'
 * '<S19>'  : 'leader_qbot2/Waypoint Controller/Second-Order Low-Pass Filter1'
 * '<S20>'  : 'leader_qbot2/Waypoint Controller/Second-Order Low-Pass Filter4'
 * '<S21>'  : 'leader_qbot2/Waypoint Controller/Trajectory control (Way-points)'
 * '<S22>'  : 'leader_qbot2/Waypoint Controller/Trajectory control (Way-points)/Way Point Control'
 */
