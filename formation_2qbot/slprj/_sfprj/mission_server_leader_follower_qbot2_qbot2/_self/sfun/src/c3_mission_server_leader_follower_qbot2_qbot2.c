...
#include "c3_mission_server_leader_follower_qbot2_qbot2.h"
...
static const char * c3_debug_family_names[13] = { "DIST_THRESHOLD", "dist",
  "nargin", "nargout", "x_waypoint", "z_waypoint", "x_ugv", "z_ugv", "x_ref",
  "z_ref", "waypoint_num", "mission_complete", "idx" };

/* Function Declarations */
static void initialize_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static void initialize_params_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static void enable_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static void disable_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_mission_server_leader_follower_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static const mxArray
  *get_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static void set_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance,
   const mxArray *c3_st);
static void finalize_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static void sf_gateway_c3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
static void initSimStructsc3_mission_server_leader_follower_qbot2_qbot2
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance);
...
static real_T c3_emlrt_marshallIn
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance,
   const mxArray *c3_b_idx, const char_T *c3_identifier);
...
static real_T c3_c_emlrt_marshallIn
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance,
   const mxArray *c3_mission_complete, const char_T *c3_identifier);
...
static uint8_T c3_f_emlrt_marshallIn
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance,
   const mxArray *c3_b_is_active_c3_mission_server_leader_follower_qbot2_qbot2,
  ...
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_idx_not_empty = false;
  chartInstance->c3_is_active_c3_mission_server_leader_follower_qbot2_qbot2 = 0U;
}
  ...
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance)
{
  ...
  real_T *c3_mission_complete;
  real_T *c3_waypoint_num;
  real_T *c3_x_ref;
  real_T *c3_z_ref;
  c3_mission_complete = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c3_waypoint_num = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c3_z_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_x_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellmatrix(6, 1), false);
  c3_hoistedGlobal = *c3_mission_complete;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = *c3_waypoint_num;
  c3_b_u = c3_b_hoistedGlobal;
  c3_c_y = NULL;
  sf_mex_assign(&c3_c_y, sf_mex_create("y", &c3_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 1, c3_c_y);
  c3_c_hoistedGlobal = *c3_x_ref;
  c3_c_u = c3_c_hoistedGlobal;
  c3_d_y = NULL;
  sf_mex_assign(&c3_d_y, sf_mex_create("y", &c3_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 2, c3_d_y);
  c3_d_hoistedGlobal = *c3_z_ref;
  c3_d_u = c3_d_hoistedGlobal;
  c3_e_y = NULL;
  sf_mex_assign(&c3_e_y, sf_mex_create("y", &c3_d_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 3, c3_e_y);
  c3_e_hoistedGlobal = chartInstance->c3_idx;
  c3_e_u = c3_e_hoistedGlobal;
  c3_f_y = NULL;
  if (!chartInstance->c3_idx_not_empty) {
  ...
  c3_f_hoistedGlobal =
    chartInstance->c3_is_active_c3_mission_server_leader_follower_qbot2_qbot2;
   ...
   const mxArray *c3_st)
{
  ...
  *c3_mission_complete = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 0)), "mission_complete");
  *c3_waypoint_num = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 1)), "waypoint_num");
  *c3_x_ref = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 2)), "x_ref");
  *c3_z_ref = c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c3_u, 3)), "z_ref");
  chartInstance->c3_idx = c3_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c3_u, 4)), "idx");
  chartInstance->c3_is_active_c3_mission_server_leader_follower_qbot2_qbot2 =
    c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 5)),
    "is_active_c3_mission_server_leader_follower_qbot2_qbot2");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_mission_server_leader_follower_qbot2(chartInstance);
  ...
  (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance)
{
  ...
  real_T c3_c_hoistedGlobal;
  real_T c3_d_hoistedGlobal;
  real_T c3_x_waypoint;
  real_T c3_z_waypoint;
  real_T c3_x_ugv;
  real_T c3_z_ugv;
  uint32_T c3_debug_family_var_map[13];
  real_T c3_DIST_THRESHOLD;
  real_T c3_dist;
  ...
  int32_T c3_i0;
  real_T c3_b_x[2];
  real_T *c3_b_x_waypoint;
  real_T *c3_b_x_ref;
  real_T *c3_b_z_waypoint;
  real_T *c3_b_x_ugv;
  real_T *c3_b_z_ugv;
  real_T *c3_b_z_ref;
  real_T *c3_b_waypoint_num;
  real_T *c3_b_mission_complete;
  boolean_T guard1 = false;
  c3_b_mission_complete = (real_T *)ssGetOutputPortSignal(chartInstance->S, 4);
  c3_b_waypoint_num = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
  c3_b_z_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_b_z_ugv = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c3_b_x_ugv = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c3_b_z_waypoint = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c3_b_x_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_b_x_waypoint = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c3_b_x_waypoint, 0U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_b_x_waypoint;
  c3_b_hoistedGlobal = *c3_b_z_waypoint;
  c3_c_hoistedGlobal = *c3_b_x_ugv;
  c3_d_hoistedGlobal = *c3_b_z_ugv;
  c3_x_waypoint = c3_hoistedGlobal;
  c3_z_waypoint = c3_b_hoistedGlobal;
  c3_x_ugv = c3_c_hoistedGlobal;
  c3_z_ugv = c3_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 13U, 13U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_DIST_THRESHOLD, 0U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_dist, 1U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 3U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_x_waypoint, 4U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_z_waypoint, 5U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_x_ugv, 6U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_z_ugv, 7U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_x_ref, 8U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_z_ref, 9U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_waypoint_num, 10U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_mission_complete, 11U,
    c3_b_sf_marshallOut, c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c3_idx, 12U,
    c3_sf_marshallOut, c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 9);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 11);
  if (CV_EML_IF(0, 1, 0, !chartInstance->c3_idx_not_empty)) {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 12);
    chartInstance->c3_idx = 1.0;
    chartInstance->c3_idx_not_empty = true;
  }

  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 15);
  c3_mission_complete = 0.0;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 18);
  c3_DIST_THRESHOLD = 0.15;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 21);
  (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("x_waypoint", (int32_T)_SFD_INTEGER_CHECK(
    "idx", chartInstance->c3_idx), 1, 1, 1, 0);
  (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("z_waypoint", (int32_T)_SFD_INTEGER_CHECK(
    "idx", chartInstance->c3_idx), 1, 1, 1, 0);
  c3_x[0] = c3_x_ugv - c3_x_waypoint;
  c3_x[1] = c3_z_ugv - c3_z_waypoint;
  for (c3_i0 = 0; c3_i0 < 2; c3_i0++) {
    c3_b_x[c3_i0] = c3_x[c3_i0];
  }

  c3_dist = c3_eml_xnrm2(chartInstance, c3_b_x);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 23);
  guard1 = false;
  if (CV_EML_COND(0, 1, 0, c3_dist > c3_DIST_THRESHOLD)) {
    guard1 = true;
  } else if (CV_EML_COND(0, 1, 1, chartInstance->c3_idx == 1.0)) {
    guard1 = true;
  } else {
    CV_EML_MCDC(0, 1, 0, false);
    CV_EML_IF(0, 1, 1, false);
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 27);
    chartInstance->c3_idx++;
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 28);
    (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("x_waypoint", (int32_T)
      _SFD_INTEGER_CHECK("idx", chartInstance->c3_idx), 1, 1, 1, 0);
    c3_x_ref = c3_x_waypoint;
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 29);
    (real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("z_waypoint", (int32_T)
      _SFD_INTEGER_CHECK("idx", chartInstance->c3_idx), 1, 1, 1, 0);
    c3_z_ref = c3_z_waypoint;
  }
  ...
  c3_waypoint_num = chartInstance->c3_idx;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 35);
  if (CV_EML_IF(0, 1, 2, chartInstance->c3_idx == 1.0)) {
    _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 36);
    c3_mission_complete = 1.0;
  }
  ...
  *c3_b_x_ref = c3_x_ref;
  *c3_b_z_ref = c3_z_ref;
  *c3_b_waypoint_num = c3_waypoint_num;
  *c3_b_mission_complete = c3_mission_complete;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY
    (_mission_server_leader_follower_qbot2_qbot2MachineNumber_,
     chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c3_b_x_ref, 1U);
  _SFD_DATA_RANGE_CHECK(*c3_b_z_waypoint, 2U);
  _SFD_DATA_RANGE_CHECK(*c3_b_x_ugv, 3U);
  _SFD_DATA_RANGE_CHECK(*c3_b_z_ugv, 4U);
  _SFD_DATA_RANGE_CHECK(*c3_b_z_ref, 5U);
  _SFD_DATA_RANGE_CHECK(*c3_b_waypoint_num, 6U);
  _SFD_DATA_RANGE_CHECK(*c3_b_mission_complete, 7U);
}
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance;
  chartInstance = (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct
                   *)chartInstanceVoid;
   ...
   const mxArray *c3_b_idx, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_idx), &c3_thisId);
  sf_mex_destroy(&c3_b_idx);
  return c3_y;
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  chartInstance = (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct
                   *)chartInstanceVoid;
  c3_b_idx = sf_mex_dup(c3_mxArrayInData);
   ...
   const mxArray *c3_mission_complete, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_mission_complete),
    &c3_thisId);
  sf_mex_destroy(&c3_mission_complete);
  return c3_y;
}
...
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_mission_complete;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  real_T c3_y;
  SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance;
  chartInstance = (SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct
                   *)chartInstanceVoid;
  c3_mission_complete = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_mission_complete),
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!genpnorm"),
                  "context", "context", 4);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_xnrm2"), "name", "name", 4);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 11);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("realmin"), "name", "name", 11);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
   ...
   const char_T *c3_identifier)
{
  ...
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_mission_server_leader_follower_qbot2_qbot2), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_mission_server_leader_follower_qbot2_qbot2);
  return c3_y;
}
...
void sf_c3_mission_server_leader_follower_qbot2_qbot2_get_check_sum(mxArray
  *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1969764316U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1263847545U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(745652481U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(449040003U);
}

mxArray
  *sf_c3_mission_server_leader_follower_qbot2_qbot2_get_autoinheritance_info
  (void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("cMZzQeTsjiKa2kSP6ogJAF");
...
mxArray *sf_c3_mission_server_leader_follower_qbot2_qbot2_third_party_uses_info
  (void)
{
...
mxArray
  *sf_c3_mission_server_leader_follower_qbot2_qbot2_updateBuildInfo_args_info
  (void)
{
...
static const mxArray
  *sf_get_sim_state_info_c3_mission_server_leader_follower_qbot2_qbot2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[14],T\"mission_complete\",},{M[1],M[13],T\"waypoint_num\",},{M[1],M[5],T\"x_ref\",},{M[1],M[11],T\"z_ref\",},{M[4],M[0],T\"idx\",S'l','i','p'{{M1x2[370 373],M[0],}}},{M[8],M[0],T\"is_active_c3_mission_server_leader_follower_qbot2_qbot2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_mission_server_leader_follower_qbot2_qbot2_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c3_waypoint_num;
          real_T *c3_mission_complete;
          c3_mission_complete = (real_T *)ssGetOutputPortSignal(chartInstance->S,
            4);
          c3_waypoint_num = (real_T *)ssGetOutputPortSignal(chartInstance->S, 3);
          c3_z_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c3_z_ugv = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
          c3_x_ugv = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
          c3_z_waypoint = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c3_x_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c3_x_waypoint = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c3_x_waypoint);
          _SFD_SET_DATA_VALUE_PTR(1U, c3_x_ref);
          _SFD_SET_DATA_VALUE_PTR(2U, c3_z_waypoint);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_x_ugv);
          _SFD_SET_DATA_VALUE_PTR(4U, c3_z_ugv);
          _SFD_SET_DATA_VALUE_PTR(5U, c3_z_ref);
          _SFD_SET_DATA_VALUE_PTR(6U, c3_waypoint_num);
          _SFD_SET_DATA_VALUE_PTR(7U, c3_mission_complete);
        }
      }
    } else {
...
{
  return "IBiiKIvBNkV5ad0spWgMUF";
}

static void sf_opaque_initialize_c3_mission_server_leader_follower_qbot2_qbot2
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c3_mission_server_leader_follower_qbot2_qbot2
    ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
     chartInstanceVar);
  initialize_c3_mission_server_leader_follower_qbot2_qbot2
    ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c3_mission_server_leader_follower_qbot2_qbot2(void *
  chartInstanceVar)
{
  enable_c3_mission_server_leader_follower_qbot2_qbot2
    ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c3_mission_server_leader_follower_qbot2_qbot2(void
  *chartInstanceVar)
{
  disable_c3_mission_server_leader_follower_qbot2_qbot2
    ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c3_mission_server_leader_follower_qbot2_qbot2(void
  *chartInstanceVar)
{
  sf_gateway_c3_mission_server_leader_follower_qbot2_qbot2
    ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c3_mission_server_leader_follower_qbot2_qbot2();/* state var info */
...
extern void
  sf_internal_set_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
    ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
    (S);
}

static void
  sf_opaque_set_sim_state_c3_mission_server_leader_follower_qbot2_qbot2
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_mission_server_leader_follower_qbot2_qbot2(S, st);
}

static void sf_opaque_terminate_c3_mission_server_leader_follower_qbot2_qbot2
  (void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c3_mission_server_leader_follower_qbot2_qbot2
      ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc3_mission_server_leader_follower_qbot2_qbot2
    ((SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_mission_server_leader_follower_qbot2_qbot2
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_mission_server_leader_follower_qbot2_qbot2
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
  ...
  ssSetChecksum0(S,(817648364U));
  ssSetChecksum1(S,(2667264372U));
  ssSetChecksum2(S,(3843975250U));
  ssSetChecksum3(S,(3879837393U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_mission_server_leader_follower_qbot2_qbot2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_mission_server_leader_follower_qbot2_qbot2(SimStruct *S)
{
  SFc3_mission_server_leader_follower_qbot2_qbot2InstanceStruct *chartInstance;
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c3_mission_server_leader_follower_qbot2_qbot2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_mission_server_leader_follower_qbot2_qbot2;
...
void c3_mission_server_leader_follower_qbot2_qbot2_method_dispatcher(SimStruct
  *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_mission_server_leader_follower_qbot2_qbot2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_mission_server_leader_follower_qbot2_qbot2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_mission_server_leader_follower_qbot2_qbot2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_mission_server_leader_follower_qbot2_qbot2_method_dispatcher.\n"
