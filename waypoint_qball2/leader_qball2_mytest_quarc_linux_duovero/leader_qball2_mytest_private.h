 ...
 */
#ifndef RTW_HEADER_leader_qball2_mytest_private_h_
#define RTW_HEADER_leader_qball2_mytest_private_h_
#include "rtwtypes.h"
...
extern void leade_EnabledSubsystem1_Disable(B_EnabledSubsystem1_leader_qb_T
  *localB, DW_EnabledSubsystem1_leader_q_T *localDW,
  P_EnabledSubsystem1_leader_qb_T *localP);
extern void leader_qball2_EnabledSubsystem1(RT_MODEL_leader_qball2_mytest_T *
  const leader_qball2_mytest_M, boolean_T rtu_Enable, real_T rtu_timeoutlimit,
  B_EnabledSubsystem1_leader_qb_T *localB, DW_EnabledSubsystem1_leader_q_T
  *localDW, P_EnabledSubsystem1_leader_qb_T *localP);
extern void leader_qball2_mytest_step0(void);
extern void leader_qball2_mytest_step2(void);/* private model entry point functions */
extern void leader_qball2_mytest_derivatives(void);

#endif                                 /* RTW_HEADER_leader_qball2_mytest_private_h_ */
