  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (leader_qball2_mytest_P)
    ;%
      section.nData     = 119;
      section.data(119)  = dumData; %prealloc
      
	  ;% leader_qball2_mytest_P.KdHEIGHT_DOWN
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.KdHEIGHT_UP
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.KdOUTER_PITCH_DOWN
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_P.KdOUTER_PITCH_UP
	  ...
	  ;% leader_qball2_mytest_P.KdOUTER_ROLL_UP
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 5;
	
	  ;% leader_qball2_mytest_P.KdPITCH_DOWN
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 6;
	
	  ;% leader_qball2_mytest_P.KdPITCH_UP
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 7;
	
	  ;% leader_qball2_mytest_P.KdROLL_DOWN
	  section.data(9).logicalSrcIdx = 8;
	  section.data(9).dtTransOffset = 8;
	
	  ;% leader_qball2_mytest_P.KdROLL_UP
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 9;
	
	  ;% leader_qball2_mytest_P.KdYAW_DOWN
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 10;
	
	  ;% leader_qball2_mytest_P.KdYAW_UP
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 11;
	
	  ;% leader_qball2_mytest_P.KiHEIGHT_DOWN
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 12;
	
	  ;% leader_qball2_mytest_P.KiHEIGHT_UP
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 13;
	
	  ;% leader_qball2_mytest_P.KiOUTER_PITCH_DOWN
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 14;
	
	  ;% leader_qball2_mytest_P.KiOUTER_PITCH_UP
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 15;
	
	  ;% leader_qball2_mytest_P.KiOUTER_ROLL_DOWN
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 16;
	
	  ;% leader_qball2_mytest_P.KiOUTER_ROLL_UP
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 17;
	
	  ;% leader_qball2_mytest_P.KiPITCH_DOWN
	  section.data(19).logicalSrcIdx = 18;
	  section.data(19).dtTransOffset = 18;
	
	  ;% leader_qball2_mytest_P.KiPITCH_UP
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 19;
	
	  ;% leader_qball2_mytest_P.KiROLL_DOWN
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 20;
	
	  ;% leader_qball2_mytest_P.KiROLL_UP
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 21;
	
	  ;% leader_qball2_mytest_P.KiYAW_DOWN
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 22;
	
	  ;% leader_qball2_mytest_P.KiYAW_UP
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 23;
	
	  ;% leader_qball2_mytest_P.KpHEIGHT_DOWN
	  section.data(25).logicalSrcIdx = 24;
	  section.data(25).dtTransOffset = 24;
	
	  ;% leader_qball2_mytest_P.KpHEIGHT_UP
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 25;
	
	  ;% leader_qball2_mytest_P.KpOUTER_PITCH_DOWN
	  section.data(27).logicalSrcIdx = 26;
	  section.data(27).dtTransOffset = 26;
	
	  ;% leader_qball2_mytest_P.KpOUTER_PITCH_UP
	  section.data(28).logicalSrcIdx = 27;
	  section.data(28).dtTransOffset = 27;
	
	  ;% leader_qball2_mytest_P.KpOUTER_ROLL_DOWN
	  section.data(29).logicalSrcIdx = 28;
	  section.data(29).dtTransOffset = 28;
	
	  ;% leader_qball2_mytest_P.KpOUTER_ROLL_UP
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 29;
	
	  ;% leader_qball2_mytest_P.KpPITCH_DOWN
	  section.data(31).logicalSrcIdx = 30;
	  section.data(31).dtTransOffset = 30;
	
	  ;% leader_qball2_mytest_P.KpPITCH_UP
	  section.data(32).logicalSrcIdx = 31;
	  section.data(32).dtTransOffset = 31;
	
	  ;% leader_qball2_mytest_P.KpROLL_DOWN
	  section.data(33).logicalSrcIdx = 32;
	  section.data(33).dtTransOffset = 32;
	
	  ;% leader_qball2_mytest_P.KpROLL_UP
	  section.data(34).logicalSrcIdx = 33;
	  section.data(34).dtTransOffset = 33;
	
	  ;% leader_qball2_mytest_P.KpYAW_DOWN
	  section.data(35).logicalSrcIdx = 34;
	  section.data(35).dtTransOffset = 34;
	
	  ;% leader_qball2_mytest_P.KpYAW_UP
	  section.data(36).logicalSrcIdx = 35;
	  section.data(36).dtTransOffset = 35;
	
	  ;% leader_qball2_mytest_P.LIMIT_CMD_PITCH
	  section.data(37).logicalSrcIdx = 36;
	  section.data(37).dtTransOffset = 36;
	
	  ;% leader_qball2_mytest_P.LIMIT_CMD_ROLL
	  section.data(38).logicalSrcIdx = 37;
	  section.data(38).dtTransOffset = 37;
	
	  ;% leader_qball2_mytest_P.LIMIT_MAX_HEIGHT
	  section.data(39).logicalSrcIdx = 38;
	  section.data(39).dtTransOffset = 38;
	
	  ;% leader_qball2_mytest_P.LIMIT_MAX_X
	  section.data(40).logicalSrcIdx = 39;
	  section.data(40).dtTransOffset = 39;
	
	  ;% leader_qball2_mytest_P.LIMIT_MAX_Z
	  section.data(41).logicalSrcIdx = 40;
	  section.data(41).dtTransOffset = 40;
	
	  ;% leader_qball2_mytest_P.LIMIT_MIN_HEIGHT
	  section.data(42).logicalSrcIdx = 41;
	  section.data(42).dtTransOffset = 41;
	
	  ;% leader_qball2_mytest_P.LIMIT_MIN_X
	  section.data(43).logicalSrcIdx = 42;
	  section.data(43).dtTransOffset = 42;
	
	  ;% leader_qball2_mytest_P.LIMIT_MIN_Z
	  section.data(44).logicalSrcIdx = 43;
	  section.data(44).dtTransOffset = 43;
	
	  ;% leader_qball2_mytest_P.LIMIT_RATE_HEIGHT
	  section.data(45).logicalSrcIdx = 44;
	  section.data(45).dtTransOffset = 44;
	
	  ;% leader_qball2_mytest_P.LIMIT_RATE_X
	  section.data(46).logicalSrcIdx = 45;
	  section.data(46).dtTransOffset = 45;
	
	  ;% leader_qball2_mytest_P.LIMIT_RATE_Z
	  section.data(47).logicalSrcIdx = 46;
	  section.data(47).dtTransOffset = 46;
	
	  ;% leader_qball2_mytest_P.LIMIT_uCMD_PITCH
	  section.data(48).logicalSrcIdx = 47;
	  section.data(48).dtTransOffset = 47;
	
	  ;% leader_qball2_mytest_P.LIMIT_uCMD_ROLL
	  ...
	  ;% leader_qball2_mytest_P.OMEGA_DIFF
	  section.data(52).logicalSrcIdx = 51;
	  section.data(52).dtTransOffset = 51;
	
	  ;% leader_qball2_mytest_P.OMEGA_FILTER
	  ...
	  ;% leader_qball2_mytest_P.TRIM_THROTTLE
	  section.data(55).logicalSrcIdx = 54;
	  section.data(55).dtTransOffset = 54;
	
	  ;% leader_qball2_mytest_P.TRIM_U_PITCH
	  section.data(56).logicalSrcIdx = 55;
	  section.data(56).dtTransOffset = 55;
	
	  ;% leader_qball2_mytest_P.TRIM_U_ROLL
	  ...
	  ;% leader_qball2_mytest_P.FOH1_Ts
	  ...
	  ;% leader_qball2_mytest_P.CompareToConstant_const_c
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_final_pwm_outputs
	  section.data(84).logicalSrcIdx = 83;
	  section.data(84).dtTransOffset = 96;
	
	  ;% leader_qball2_mytest_P.SliderGain_gain
	  section.data(85).logicalSrcIdx = 84;
	  section.data(85).dtTransOffset = 97;
	
	  ;% leader_qball2_mytest_P.Joystickyawcommandgain1_gain
	  ...
	  ;% leader_qball2_mytest_P.SliderGain1_gain
	  section.data(91).logicalSrcIdx = 90;
	  section.data(91).dtTransOffset = 103;
	
	  ;% leader_qball2_mytest_P.SliderGain3_gain
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_initial_pwm_outpu
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_pwm_frequency
	  section.data(109).logicalSrcIdx = 108;
	  section.data(109).dtTransOffset = 121;
	
	  ;% leader_qball2_mytest_P.HILInitialize_pwm_leading_deadb
	  section.data(110).logicalSrcIdx = 109;
	  section.data(110).dtTransOffset = 122;
	
	  ;% leader_qball2_mytest_P.HILInitialize_pwm_trailing_dead
	  section.data(111).logicalSrcIdx = 110;
	  section.data(111).dtTransOffset = 123;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_other_outputs
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_set_other_outpu_i
	  section.data(115).logicalSrcIdx = 114;
	  section.data(115).dtTransOffset = 127;
	
	  ;% leader_qball2_mytest_P.BiasRemoval_start_time
	  section.data(116).logicalSrcIdx = 115;
	  section.data(116).dtTransOffset = 128;
	
	  ;% leader_qball2_mytest_P.BiasRemoval_switch_id
	  section.data(117).logicalSrcIdx = 116;
	  section.data(117).dtTransOffset = 129;
	
	  ;% leader_qball2_mytest_P.HILInitialize_watchdog_other_ou
	  section.data(118).logicalSrcIdx = 117;
	  section.data(118).dtTransOffset = 130;
	
	  ;% leader_qball2_mytest_P.HILInitialize_watchdog_pwm_outp
	  section.data(119).logicalSrcIdx = 118;
	  section.data(119).dtTransOffset = 131;
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_pwm_alignment
	  section.data(1).logicalSrcIdx = 119;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.HILInitialize_pwm_configuration
	  section.data(2).logicalSrcIdx = 120;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.HILInitialize_pwm_modes
	  section.data(3).logicalSrcIdx = 121;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_P.HILInitialize_pwm_polarity
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_analog_input_chan
	  section.data(1).logicalSrcIdx = 124;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.HILReadWrite1_analog_input_chan
	  ...
	  ;% leader_qball2_mytest_P.HILReadWrite1_digital_output_ch
	  section.data(4).logicalSrcIdx = 127;
	  section.data(4).dtTransOffset = 6;
	
	  ;% leader_qball2_mytest_P.HILReadWrite1_other_input_chann
	  ...
	  ;% leader_qball2_mytest_P.HILReadWrite1_other_output_chan
	  ...
	  ;% leader_qball2_mytest_P.ShowMessageonHost1_message_icon
	  section.data(1).logicalSrcIdx = 131;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.ShowMessageonHost_message_icon
	  section.data(2).logicalSrcIdx = 132;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.ShowMessageonHost1_message_ic_m
	  section.data(3).logicalSrcIdx = 133;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_P.ShowMessageonHost_message_ico_h
	  section.data(4).logicalSrcIdx = 134;
	  section.data(4).dtTransOffset = 3;
	
	  ;% leader_qball2_mytest_P.ShowMessageonHost1_message_i_m5
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_active
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_input_
	  ...
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_output
	  section.data(6).logicalSrcIdx = 141;
	  section.data(6).dtTransOffset = 6;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_outp_g
	  section.data(7).logicalSrcIdx = 142;
	  section.data(7).dtTransOffset = 7;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_out_gi
	  section.data(8).logicalSrcIdx = 143;
	  section.data(8).dtTransOffset = 8;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_outp_l
	  section.data(9).logicalSrcIdx = 144;
	  section.data(9).dtTransOffset = 9;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_outp_m
	  section.data(10).logicalSrcIdx = 145;
	  section.data(10).dtTransOffset = 10;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_outp_h
	  section.data(11).logicalSrcIdx = 146;
	  section.data(11).dtTransOffset = 11;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_analog_out_m2
	  section.data(12).logicalSrcIdx = 147;
	  section.data(12).dtTransOffset = 12;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 148;
	  section.data(13).dtTransOffset = 13;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_clock_frequ_i
	  section.data(14).logicalSrcIdx = 149;
	  section.data(14).dtTransOffset = 14;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 150;
	  section.data(15).dtTransOffset = 15;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_clock_param_b
	  section.data(16).logicalSrcIdx = 151;
	  section.data(16).dtTransOffset = 16;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 152;
	  section.data(17).dtTransOffset = 17;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_digital_out_a
	  section.data(18).logicalSrcIdx = 153;
	  section.data(18).dtTransOffset = 18;
	
	  ;% leader_qball2_mytest_P.HILInitialize_set_digital_out_c
	  ...
	  ;% leader_qball2_mytest_P.Out1_Y0
	  ...
	  ;% leader_qball2_mytest_P.TransformGyroDataForBatteryBott
	  section.data(6).logicalSrcIdx = 176;
	  section.data(6).dtTransOffset = 5;
	
	  ;% leader_qball2_mytest_P.TransformAccelerometerDataForBa
	  section.data(7).logicalSrcIdx = 177;
	  section.data(7).dtTransOffset = 8;
	
	  ;% leader_qball2_mytest_P.zero_Y0
	  section.data(8).logicalSrcIdx = 178;
	  section.data(8).dtTransOffset = 11;
	
	  ;% leader_qball2_mytest_P.Vbiased_Y0
	  section.data(9).logicalSrcIdx = 179;
	  section.data(9).dtTransOffset = 12;
	
	  ;% leader_qball2_mytest_P.Vunbiased_Y0
	  section.data(10).logicalSrcIdx = 180;
	  section.data(10).dtTransOffset = 13;
	
	  ;% leader_qball2_mytest_P.Stepstart_time_Y0
	  section.data(11).logicalSrcIdx = 181;
	  section.data(11).dtTransOffset = 14;
	
	  ;% leader_qball2_mytest_P.Stepstart_time_YFinal
	  section.data(12).logicalSrcIdx = 182;
	  section.data(12).dtTransOffset = 15;
	
	  ;% leader_qball2_mytest_P.Stepend_time_Y0
	  section.data(13).logicalSrcIdx = 183;
	  section.data(13).dtTransOffset = 16;
	
	  ;% leader_qball2_mytest_P.Stepend_time_YFinal
	  section.data(14).logicalSrcIdx = 184;
	  section.data(14).dtTransOffset = 17;
	
	  ;% leader_qball2_mytest_P.unity_Value
	  ...
	  ;% leader_qball2_mytest_P.Out1_Y0_f
	  ...
	  ;% leader_qball2_mytest_P.Out1_Y0_o
	  ...
	  ;% leader_qball2_mytest_P.Out1_Y0_g
	  ...
	  ;% leader_qball2_mytest_P.Out1_Y0_l
	  ...
	  ;% leader_qball2_mytest_P.Joystickthrottlescaling_Gain
	  ...
	  ;% leader_qball2_mytest_P.Out1_Y0_gt
	  ...
	  ;% leader_qball2_mytest_P.Out1_Y0_lz
	  ...
	  ;% leader_qball2_mytest_P.Motorenable_Value
	  section.data(41).logicalSrcIdx = 211;
	  section.data(41).dtTransOffset = 44;
	
	  ;% leader_qball2_mytest_P.Memory_X0
	  ...
	  ;% leader_qball2_mytest_P.Constant_Value_b
	  ...
	  ;% leader_qball2_mytest_P.Constant3_Value
	  ...
	  ;% leader_qball2_mytest_P.x0_Value
	  ...
	  ;% leader_qball2_mytest_P.Constant_Value_jv
	  ...
	  ;% leader_qball2_mytest_P.Constant1_Value
	  ...
	  ;% leader_qball2_mytest_P.Gain2_Gain
	  section.data(82).logicalSrcIdx = 252;
	  section.data(82).dtTransOffset = 89;
	
	  ;% leader_qball2_mytest_P.Gain6_Gain
	  ...
	  ;% leader_qball2_mytest_P.x0_Value_h
	  ...
	  ;% leader_qball2_mytest_P.x0_Value_c
	  ...
	  ;% leader_qball2_mytest_P.x0_Value_k
	  ...
	  ;% leader_qball2_mytest_P.Gain1_Gain_b
	  section.data(94).logicalSrcIdx = 264;
	  section.data(94).dtTransOffset = 101;
	
	  ;% leader_qball2_mytest_P.Gain_Gain
	  ...
	  ;% leader_qball2_mytest_P.initialaccel_Value
	  ...
	  ;% leader_qball2_mytest_P.TransferFcn_A
	  section.data(102).logicalSrcIdx = 272;
	  section.data(102).dtTransOffset = 111;
	
	  ;% leader_qball2_mytest_P.TransferFcn_C
	  ...
	  ;% leader_qball2_mytest_P.LowPassFilterFilteredYawRate_C
	  ...
	  ;% leader_qball2_mytest_P.headingcommand_Value
	  ...
	  ;% leader_qball2_mytest_P.RateLimiter_IC
	  section.data(124).logicalSrcIdx = 294;
	  section.data(124).dtTransOffset = 133;
	
	  ;% leader_qball2_mytest_P.Bias_Bias
	  ...
	  ;% leader_qball2_mytest_P.Saturation3_UpperSat
	  section.data(127).logicalSrcIdx = 297;
	  section.data(127).dtTransOffset = 136;
	
	  ;% leader_qball2_mytest_P.Saturation3_LowerSat
	  ...
	  ;% leader_qball2_mytest_P.SignalGenerator_Amplitude
	  section.data(139).logicalSrcIdx = 309;
	  section.data(139).dtTransOffset = 148;
	
	  ;% leader_qball2_mytest_P.SignalGenerator_Frequency
	  ...
	  ;% leader_qball2_mytest_P.LowPassFilterFilteredYawRateF_c
	  ...
	  ;% leader_qball2_mytest_P.Gain2_Gain_k
	  ...
	  ;% leader_qball2_mytest_P.LowPassFilterFilteredPitchRat_e
	  ...
	  ;% leader_qball2_mytest_P.LowPassFilterFilteredRollRate_C
	  ...
	  ;% leader_qball2_mytest_P.StepInitializezerothrottlefor_c
	  section.data(184).logicalSrcIdx = 354;
	  section.data(184).dtTransOffset = 193;
	
	  ;% leader_qball2_mytest_P.StepInitializezerothrottlefor_a
	  ...
	  ;% leader_qball2_mytest_P.Gain_Gain_n
	  section.data(187).logicalSrcIdx = 357;
	  section.data(187).dtTransOffset = 196;
	
	  ;% leader_qball2_mytest_P.Constant_Value_k
	  ...
	  ;% leader_qball2_mytest_P.Constant_Value_d
	  ...
	  ;% leader_qball2_mytest_P.TransportDelay_Delay
	  ...
	  ;% leader_qball2_mytest_P.Gain4_Gain_k
	  ...
	  ;% leader_qball2_mytest_P.SignalGenerator1_Amplitude
	  section.data(203).logicalSrcIdx = 373;
	  section.data(203).dtTransOffset = 212;
	
	  ;% leader_qball2_mytest_P.SignalGenerator1_Frequency
	  ...
	  ;% leader_qball2_mytest_P.x0_Value_b
	  ...
	  ;% leader_qball2_mytest_P.x0_Value_p
	  ...
	  ;% leader_qball2_mytest_P.Gain1_Gain_ln
	  ...
	  ;% leader_qball2_mytest_P.Enable_Value
	  ...
	  ;% leader_qball2_mytest_P.x0_Value_ch
	  ...
	  ;% leader_qball2_mytest_P.StreamClient_SndPriority
	  ...
	  ;% leader_qball2_mytest_P.StreamServer_RcvPriority
	  ...
	  ;% leader_qball2_mytest_P.StreamClient_SndSize
	  ...
	  ;% leader_qball2_mytest_P.StreamClient_SndFIFO
	  ...
	  ;% leader_qball2_mytest_P.ToHostFile_Decimation
	  section.data(5).logicalSrcIdx = 404;
	  section.data(5).dtTransOffset = 4;
	
	  ;% leader_qball2_mytest_P.StreamServer_SndSize
	  section.data(6).logicalSrcIdx = 405;
	  section.data(6).dtTransOffset = 5;
	
	  ;% leader_qball2_mytest_P.StreamServer_RcvSize
	  section.data(7).logicalSrcIdx = 406;
	  section.data(7).dtTransOffset = 6;
	
	  ;% leader_qball2_mytest_P.StreamServer_SndFIFO
	  section.data(8).logicalSrcIdx = 407;
	  section.data(8).dtTransOffset = 7;
	
	  ;% leader_qball2_mytest_P.StreamServer_RcvFIFO
	  ...
	  ;% leader_qball2_mytest_P.StreamClient_Optimize
	  section.data(1).logicalSrcIdx = 409;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.StreamClient_Implementation
	  section.data(2).logicalSrcIdx = 410;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.StreamServer_Optimize
	  section.data(3).logicalSrcIdx = 411;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_P.StreamServer_Implementation
	  ...
	  ;% leader_qball2_mytest_P.StringConstant1_Value
	  section.data(1).logicalSrcIdx = 413;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.StreamClient_URI
	  section.data(2).logicalSrcIdx = 414;
	  section.data(2).dtTransOffset = 80;
	
	  ;% leader_qball2_mytest_P.StreamClient_Endian
	  section.data(3).logicalSrcIdx = 415;
	  section.data(3).dtTransOffset = 81;
	
	  ;% leader_qball2_mytest_P.BatteryTopOrBottom_CurrentSetti
	  section.data(4).logicalSrcIdx = 416;
	  section.data(4).dtTransOffset = 82;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting
	  section.data(5).logicalSrcIdx = 417;
	  section.data(5).dtTransOffset = 83;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting_m
	  section.data(6).logicalSrcIdx = 418;
	  section.data(6).dtTransOffset = 84;
	
	  ;% leader_qball2_mytest_P.ManualSwitch2_CurrentSetting
	  section.data(7).logicalSrcIdx = 419;
	  section.data(7).dtTransOffset = 85;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting_f
	  section.data(8).logicalSrcIdx = 420;
	  section.data(8).dtTransOffset = 86;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting_l
	  section.data(9).logicalSrcIdx = 421;
	  section.data(9).dtTransOffset = 87;
	
	  ;% leader_qball2_mytest_P.ManualSwitch4_CurrentSetting
	  section.data(10).logicalSrcIdx = 422;
	  section.data(10).dtTransOffset = 88;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting_lk
	  section.data(11).logicalSrcIdx = 423;
	  section.data(11).dtTransOffset = 89;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting_j
	  section.data(12).logicalSrcIdx = 424;
	  section.data(12).dtTransOffset = 90;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting_k
	  section.data(13).logicalSrcIdx = 425;
	  section.data(13).dtTransOffset = 91;
	
	  ;% leader_qball2_mytest_P.ManualSwitch_CurrentSetting_h
	  section.data(14).logicalSrcIdx = 426;
	  section.data(14).dtTransOffset = 92;
	
	  ;% leader_qball2_mytest_P.ManualSwitch1_CurrentSetting
	  section.data(15).logicalSrcIdx = 427;
	  section.data(15).dtTransOffset = 93;
	
	  ;% leader_qball2_mytest_P.ManualSwitch2_CurrentSetting_c
	  section.data(16).logicalSrcIdx = 428;
	  section.data(16).dtTransOffset = 94;
	
	  ;% leader_qball2_mytest_P.ToHostFile_file_name
	  section.data(17).logicalSrcIdx = 429;
	  section.data(17).dtTransOffset = 95;
	
	  ;% leader_qball2_mytest_P.ToHostFile_VarName
	  section.data(18).logicalSrcIdx = 430;
	  section.data(18).dtTransOffset = 138;
	
	  ;% leader_qball2_mytest_P.ToHostFile_FileFormat
	  section.data(19).logicalSrcIdx = 431;
	  section.data(19).dtTransOffset = 149;
	
	  ;% leader_qball2_mytest_P.StreamServer_URI
	  section.data(20).logicalSrcIdx = 432;
	  section.data(20).dtTransOffset = 150;
	
	  ;% leader_qball2_mytest_P.StreamServer_Endian
	  section.data(21).logicalSrcIdx = 433;
	  section.data(21).dtTransOffset = 174;
	  ...
	  ;% leader_qball2_mytest_P.HILReadWrite1_Active
	  section.data(3).logicalSrcIdx = 436;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_P.StreamClient_Active
	  section.data(4).logicalSrcIdx = 437;
	  section.data(4).dtTransOffset = 3;
	
	  ;% leader_qball2_mytest_P.HILWatchdog_Active
	  section.data(5).logicalSrcIdx = 438;
	  section.data(5).dtTransOffset = 4;
	
	  ;% leader_qball2_mytest_P.StreamServer_Active
	  section.data(6).logicalSrcIdx = 439;
	  section.data(6).dtTransOffset = 5;
	  ...
	  ;% leader_qball2_mytest_P.EnabledSubsystem1_b.Constant_Value
	  section.data(1).logicalSrcIdx = 440;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.EnabledSubsystem1_b.DiscreteTimeIntegrator_gainval
	  section.data(2).logicalSrcIdx = 441;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.EnabledSubsystem1_b.DiscreteTimeIntegrator_IC
	  ...
	  ;% leader_qball2_mytest_P.EnabledSubsystem1_b.timeout_Y0
	  ...
	  ;% leader_qball2_mytest_P.EnabledSubsystem1.Constant_Value
	  section.data(1).logicalSrcIdx = 444;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.EnabledSubsystem1.DiscreteTimeIntegrator_gainval
	  section.data(2).logicalSrcIdx = 445;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.EnabledSubsystem1.DiscreteTimeIntegrator_IC
	  ...
	  ;% leader_qball2_mytest_P.EnabledSubsystem1.timeout_Y0
	  ...
	  ;% leader_qball2_mytest_P.EnabledMovingAverage_e.unity_Value
	  section.data(1).logicalSrcIdx = 448;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.EnabledMovingAverage_e.UnitDelay_InitialCondition
	  section.data(2).logicalSrcIdx = 449;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.EnabledMovingAverage_e.Sumk1n1xk_InitialCondition
	  section.data(3).logicalSrcIdx = 450;
	  section.data(3).dtTransOffset = 2;
	  ...
	  ;% leader_qball2_mytest_P.EnabledMovingAverage_c.unity_Value
	  section.data(1).logicalSrcIdx = 451;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_P.EnabledMovingAverage_c.UnitDelay_InitialCondition
	  section.data(2).logicalSrcIdx = 452;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_P.EnabledMovingAverage_c.Sumk1n1xk_InitialCondition
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (leader_qball2_mytest_B)
    ;%
      section.nData     = 207;
      section.data(207)  = dumData; %prealloc
      
	  ;% leader_qball2_mytest_B.SampleTime
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_B.Saturation
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 1;
	  ...
	  ;% leader_qball2_mytest_B.HILReadWrite1_o2
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 6;
	
	  ;% leader_qball2_mytest_B.StreamClient_o3
	  section.data(5).logicalSrcIdx = 4;
	  ...
	  ;% leader_qball2_mytest_B.Product1
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 24;
	
	  ;% leader_qball2_mytest_B.Constant3
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% leader_qball2_mytest_B.Gain
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 32;
	
	  ;% leader_qball2_mytest_B.RateTransition3
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 33;
	
	  ;% leader_qball2_mytest_B.s
	  section.data(17).logicalSrcIdx = 16;
	  ...
	  ;% leader_qball2_mytest_B.x0
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 39;
	
	  ;% leader_qball2_mytest_B.Integrator1
	  section.data(21).logicalSrcIdx = 20;
	  ...
	  ;% leader_qball2_mytest_B.Product
	  section.data(26).logicalSrcIdx = 25;
	  section.data(26).dtTransOffset = 49;
	
	  ;% leader_qball2_mytest_B.wn_i
	  section.data(27).logicalSrcIdx = 26;
	  section.data(27).dtTransOffset = 50;
	
	  ;% leader_qball2_mytest_B.Product1_o
	  section.data(28).logicalSrcIdx = 27;
	  section.data(28).dtTransOffset = 51;
	
	  ;% leader_qball2_mytest_B.wn_g
	  section.data(29).logicalSrcIdx = 28;
	  section.data(29).dtTransOffset = 52;
	
	  ;% leader_qball2_mytest_B.Product1_k
	  section.data(30).logicalSrcIdx = 29;
	  section.data(30).dtTransOffset = 53;
	
	  ;% leader_qball2_mytest_B.Gain5
	  section.data(31).logicalSrcIdx = 30;
	  section.data(31).dtTransOffset = 54;
	
	  ;% leader_qball2_mytest_B.Gain4
	  section.data(32).logicalSrcIdx = 31;
	  section.data(32).dtTransOffset = 55;
	
	  ;% leader_qball2_mytest_B.x0_p
	  section.data(33).logicalSrcIdx = 32;
	  ...
	  ;% leader_qball2_mytest_B.Gain8
	  section.data(35).logicalSrcIdx = 34;
	  section.data(35).dtTransOffset = 58;
	
	  ;% leader_qball2_mytest_B.Gain1
	  section.data(36).logicalSrcIdx = 35;
	  section.data(36).dtTransOffset = 59;
	
	  ;% leader_qball2_mytest_B.Gain7
	  section.data(37).logicalSrcIdx = 36;
	  section.data(37).dtTransOffset = 60;
	
	  ;% leader_qball2_mytest_B.Gain2
	  section.data(38).logicalSrcIdx = 37;
	  section.data(38).dtTransOffset = 61;
	
	  ;% leader_qball2_mytest_B.Gain6
	  section.data(39).logicalSrcIdx = 38;
	  ...
	  ;% leader_qball2_mytest_B.Product_f
	  section.data(44).logicalSrcIdx = 43;
	  section.data(44).dtTransOffset = 67;
	
	  ;% leader_qball2_mytest_B.Product1_a
	  section.data(45).logicalSrcIdx = 44;
	  ...
	  ;% leader_qball2_mytest_B.Product_l
	  section.data(49).logicalSrcIdx = 48;
	  ...
	  ;% leader_qball2_mytest_B.Product_d
	  section.data(53).logicalSrcIdx = 52;
	  ...
	  ;% leader_qball2_mytest_B.Gain1_m
	  section.data(60).logicalSrcIdx = 59;
	  section.data(60).dtTransOffset = 83;
	
	  ;% leader_qball2_mytest_B.Gain_e
	  section.data(61).logicalSrcIdx = 60;
	  ...
	  ;% leader_qball2_mytest_B.Product_lj
	  section.data(65).logicalSrcIdx = 64;
	  section.data(65).dtTransOffset = 88;
	
	  ;% leader_qball2_mytest_B.Product1_e
	  section.data(66).logicalSrcIdx = 65;
	  ...
	  ;% leader_qball2_mytest_B.wn_p
	  section.data(79).logicalSrcIdx = 78;
	  section.data(79).dtTransOffset = 108;
	
	  ;% leader_qball2_mytest_B.Product1_n
	  section.data(80).logicalSrcIdx = 79;
	  section.data(80).dtTransOffset = 109;
	
	  ;% leader_qball2_mytest_B.SwitchKd
	  section.data(81).logicalSrcIdx = 80;
	  ...
	  ;% leader_qball2_mytest_B.SliderGain
	  section.data(88).logicalSrcIdx = 87;
	  section.data(88).dtTransOffset = 117;
	
	  ;% leader_qball2_mytest_B.RateLimiter3
	  section.data(89).logicalSrcIdx = 88;
	  ...
	  ;% leader_qball2_mytest_B.ContinuousSigmoid_o4
	  section.data(97).logicalSrcIdx = 96;
	  ...
	  ;% leader_qball2_mytest_B.ThrottleTrim
	  section.data(102).logicalSrcIdx = 101;
	  ...
	  ;% leader_qball2_mytest_B.SigmoidPath_o4
	  section.data(112).logicalSrcIdx = 111;
	  ...
	  ;% leader_qball2_mytest_B.Switch_e
	  section.data(114).logicalSrcIdx = 113;
	  ...
	  ;% leader_qball2_mytest_B.SwitchKp_b
	  ...
	  ;% leader_qball2_mytest_B.SwitchKp_f
	  ...
	  ;% leader_qball2_mytest_B.Product2
	  section.data(146).logicalSrcIdx = 145;
	  section.data(146).dtTransOffset = 175;
	
	  ;% leader_qball2_mytest_B.Gain_d
	  ...
	  ;% leader_qball2_mytest_B.RateLimiter2
	  section.data(151).logicalSrcIdx = 150;
	  section.data(151).dtTransOffset = 184;
	
	  ;% leader_qball2_mytest_B.Product_c
	  section.data(152).logicalSrcIdx = 151;
	  section.data(152).dtTransOffset = 185;
	
	  ;% leader_qball2_mytest_B.wn_a5
	  ...
	  ;% leader_qball2_mytest_B.RateLimiter1
	  ...
	  ;% leader_qball2_mytest_B.Gain1_k
	  ...
	  ;% leader_qball2_mytest_B.SwitchKi_n
	  section.data(183).logicalSrcIdx = 182;
	  section.data(183).dtTransOffset = 224;
	
	  ;% leader_qball2_mytest_B.SwitchKi_ih
	  ...
	  ;% leader_qball2_mytest_B.SigmoidCompute_o1
	  section.data(188).logicalSrcIdx = 187;
	  section.data(188).dtTransOffset = 229;
	
	  ;% leader_qball2_mytest_B.enable
	  ...
	  ;% leader_qball2_mytest_B.div
	  section.data(196).logicalSrcIdx = 195;
	  section.data(196).dtTransOffset = 247;
	
	  ;% leader_qball2_mytest_B.In1_g
	  ...
	  ;% leader_qball2_mytest_B.StreamClient_o2
	  section.data(1).logicalSrcIdx = 207;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_B.StreamServer_o2
	  ...
	  ;% leader_qball2_mytest_B.StreamClient_o1
	  section.data(1).logicalSrcIdx = 210;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_B.Compare
	  section.data(2).logicalSrcIdx = 211;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_B.Compare_k
	  ...
	  ;% leader_qball2_mytest_B.StreamServer_o1
	  ...
	  ;% leader_qball2_mytest_B.RelationalOperator
	  section.data(2).logicalSrcIdx = 217;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_B.RelationalOperator_o
	  section.data(3).logicalSrcIdx = 218;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_B.Compare_j
	  section.data(4).logicalSrcIdx = 219;
	  section.data(4).dtTransOffset = 3;
	
	  ;% leader_qball2_mytest_B.HILWatchdog
	  ...
	  ;% leader_qball2_mytest_B.LogicalOperator_m
	  ...
	  section.data(17).logicalSrcIdx = 232;
	  section.data(17).dtTransOffset = 16;
	
	  ;% leader_qball2_mytest_B.LogicalOperator1
	  section.data(18).logicalSrcIdx = 233;
	  section.data(18).dtTransOffset = 17;
	
	  ;% leader_qball2_mytest_B.LogicalOperator4
	  section.data(19).logicalSrcIdx = 234;
	  section.data(19).dtTransOffset = 18;
	
	  ;% leader_qball2_mytest_B.LogicalOperator1_o
	  section.data(20).logicalSrcIdx = 235;
	  section.data(20).dtTransOffset = 19;
	
	  ;% leader_qball2_mytest_B.LogicalOperator1_h
	  section.data(21).logicalSrcIdx = 236;
	  section.data(21).dtTransOffset = 20;
	
	  ;% leader_qball2_mytest_B.StreamServer_o3
	  section.data(22).logicalSrcIdx = 237;
	  section.data(22).dtTransOffset = 21;
	
	  ;% leader_qball2_mytest_B.RelationalOperator_og
	  section.data(23).logicalSrcIdx = 238;
	  section.data(23).dtTransOffset = 22;
	
	  ;% leader_qball2_mytest_B.RelationalOperator_m
	  section.data(24).logicalSrcIdx = 239;
	  section.data(24).dtTransOffset = 23;
	  ...
	  ;% leader_qball2_mytest_B.EnabledMovingAverage_e.div
	  ...
	  ;% leader_qball2_mytest_B.EnabledMovingAverage_c.div
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (leader_qball2_mytest_DW)
    ;%
      section.nData     = 1;
      section.data(1)  = dumData; %prealloc
	  ...
	  ;% leader_qball2_mytest_DW.Sumk1n1xk_DSTATE
	  ...
	  ;% leader_qball2_mytest_DW.HILInitialize_OOValues
	  section.data(6).logicalSrcIdx = 6;
	  section.data(6).dtTransOffset = 7;
	
	  ;% leader_qball2_mytest_DW.Memory_PreviousInput
	  ...
	  ;% leader_qball2_mytest_DW.TimeStampA
	  section.data(11).logicalSrcIdx = 11;
	  section.data(11).dtTransOffset = 18;
	
	  ;% leader_qball2_mytest_DW.LastUAtTimeA
	  ...
	  ;% leader_qball2_mytest_DW.LastUAtTimeB
	  ...
	  ;% leader_qball2_mytest_DW.PrevY_k
	  ...
	  ;% leader_qball2_mytest_DW.ContinuousSigmoid_Sigmoid
	  ...
	  ;% leader_qball2_mytest_DW.LastUAtTimeB_l
	  ...
	  ;% leader_qball2_mytest_DW.PrevY_i
	  ...
	  ;% leader_qball2_mytest_DW.PrevY_a
	  ...
	  ;% leader_qball2_mytest_DW.x_bias_h
	  ...
	  ;% leader_qball2_mytest_DW.ToHostFile_PointsWritten
	  ...
	  ;% leader_qball2_mytest_DW.TransportDelay_RWORK.modelTStart
	  ...
	  ;% leader_qball2_mytest_DW.HILReadWrite1_PWORK
	  section.data(1).logicalSrcIdx = 73;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.Battery_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 74;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_DW.Scope1_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 75;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_DW.height_Kalman_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 76;
	  section.data(4).dtTransOffset = 3;
	
	  ;% leader_qball2_mytest_DW.pitch_Kalman_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 77;
	  section.data(5).dtTransOffset = 4;
	
	  ;% leader_qball2_mytest_DW.roll_Kalman_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 78;
	  section.data(6).dtTransOffset = 5;
	
	  ;% leader_qball2_mytest_DW.yaw_Kalman_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 79;
	  section.data(7).dtTransOffset = 6;
	
	  ;% leader_qball2_mytest_DW.pitch_acc_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 80;
	  section.data(8).dtTransOffset = 7;
	
	  ;% leader_qball2_mytest_DW.pitch_acc_asin_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 81;
	  section.data(9).dtTransOffset = 8;
	
	  ;% leader_qball2_mytest_DW.roll_acc_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 82;
	  section.data(10).dtTransOffset = 9;
	
	  ;% leader_qball2_mytest_DW.roll_acc_asin_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 83;
	  section.data(11).dtTransOffset = 10;
	
	  ;% leader_qball2_mytest_DW.Scope_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 84;
	  section.data(12).dtTransOffset = 11;
	
	  ;% leader_qball2_mytest_DW.Scope1_PWORK_c.LoggedData
	  section.data(13).logicalSrcIdx = 85;
	  section.data(13).dtTransOffset = 12;
	
	  ;% leader_qball2_mytest_DW.accelerometerxyz_PWORK.LoggedData
	  section.data(14).logicalSrcIdx = 86;
	  section.data(14).dtTransOffset = 13;
	
	  ;% leader_qball2_mytest_DW.gyroscopexyz_PWORK.LoggedData
	  section.data(15).logicalSrcIdx = 87;
	  section.data(15).dtTransOffset = 14;
	
	  ;% leader_qball2_mytest_DW.sonar_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 88;
	  section.data(16).dtTransOffset = 15;
	
	  ;% leader_qball2_mytest_DW.FilteredAccel_PWORK.LoggedData
	  section.data(17).logicalSrcIdx = 89;
	  section.data(17).dtTransOffset = 16;
	
	  ;% leader_qball2_mytest_DW.NormalizedBiasVector_PWORK.LoggedData
	  section.data(18).logicalSrcIdx = 90;
	  section.data(18).dtTransOffset = 17;
	
	  ;% leader_qball2_mytest_DW.check_PWORK.LoggedData
	  section.data(19).logicalSrcIdx = 91;
	  section.data(19).dtTransOffset = 18;
	
	  ;% leader_qball2_mytest_DW.accelcalibrated_PWORK.LoggedData
	  section.data(20).logicalSrcIdx = 92;
	  section.data(20).dtTransOffset = 19;
	
	  ;% leader_qball2_mytest_DW.accelsoffset_PWORK.LoggedData
	  section.data(21).logicalSrcIdx = 93;
	  section.data(21).dtTransOffset = 20;
	
	  ;% leader_qball2_mytest_DW.PWM_PWORK.LoggedData
	  section.data(22).logicalSrcIdx = 94;
	  section.data(22).dtTransOffset = 21;
	
	  ;% leader_qball2_mytest_DW.sonar_PWORK_p.LoggedData
	  section.data(23).logicalSrcIdx = 95;
	  section.data(23).dtTransOffset = 22;
	
	  ;% leader_qball2_mytest_DW.HILWatchdog_PWORK
	  section.data(24).logicalSrcIdx = 96;
	  section.data(24).dtTransOffset = 23;
	
	  ;% leader_qball2_mytest_DW.watchdog_PWORK.LoggedData
	  section.data(25).logicalSrcIdx = 97;
	  section.data(25).dtTransOffset = 24;
	
	  ;% leader_qball2_mytest_DW.RollPitchrunawaycheck_PWORK.LoggedData
	  section.data(26).logicalSrcIdx = 98;
	  section.data(26).dtTransOffset = 25;
	
	  ;% leader_qball2_mytest_DW.motors_in_PWORK.LoggedData
	  section.data(27).logicalSrcIdx = 99;
	  section.data(27).dtTransOffset = 26;
	
	  ;% leader_qball2_mytest_DW.motors_out_PWORK.LoggedData
	  section.data(28).logicalSrcIdx = 100;
	  section.data(28).dtTransOffset = 27;
	
	  ;% leader_qball2_mytest_DW.Scope1_PWORK_cr.LoggedData
	  section.data(29).logicalSrcIdx = 101;
	  section.data(29).dtTransOffset = 28;
	
	  ;% leader_qball2_mytest_DW.error_PWORK.LoggedData
	  section.data(30).logicalSrcIdx = 102;
	  section.data(30).dtTransOffset = 29;
	
	  ;% leader_qball2_mytest_DW.new_PWORK.LoggedData
	  section.data(31).logicalSrcIdx = 103;
	  section.data(31).dtTransOffset = 30;
	
	  ;% leader_qball2_mytest_DW.PacketfromTarget_PWORK.LoggedData
	  section.data(32).logicalSrcIdx = 104;
	  section.data(32).dtTransOffset = 31;
	
	  ;% leader_qball2_mytest_DW.rcvdpackets_PWORK.LoggedData
	  section.data(33).logicalSrcIdx = 105;
	  section.data(33).dtTransOffset = 32;
	
	  ;% leader_qball2_mytest_DW.state_PWORK.LoggedData
	  section.data(34).logicalSrcIdx = 106;
	  section.data(34).dtTransOffset = 33;
	
	  ;% leader_qball2_mytest_DW.land_PWORK.LoggedData
	  section.data(35).logicalSrcIdx = 107;
	  section.data(35).dtTransOffset = 34;
	
	  ;% leader_qball2_mytest_DW.armed_PWORK.LoggedData
	  section.data(36).logicalSrcIdx = 108;
	  section.data(36).dtTransOffset = 35;
	
	  ;% leader_qball2_mytest_DW.Pitch_PWORK.LoggedData
	  section.data(37).logicalSrcIdx = 109;
	  section.data(37).dtTransOffset = 36;
	
	  ;% leader_qball2_mytest_DW.TransportDelay_PWORK.TUbufferPtrs
	  section.data(38).logicalSrcIdx = 110;
	  section.data(38).dtTransOffset = 37;
	
	  ;% leader_qball2_mytest_DW.Origvadjustedpitch_PWORK.LoggedData
	  section.data(39).logicalSrcIdx = 111;
	  section.data(39).dtTransOffset = 39;
	
	  ;% leader_qball2_mytest_DW.pitchcontrolsignalcomponents_PW.LoggedData
	  section.data(40).logicalSrcIdx = 112;
	  section.data(40).dtTransOffset = 40;
	
	  ;% leader_qball2_mytest_DW.Pitch1_PWORK.LoggedData
	  section.data(41).logicalSrcIdx = 113;
	  section.data(41).dtTransOffset = 41;
	
	  ;% leader_qball2_mytest_DW.Roll_PWORK.LoggedData
	  section.data(42).logicalSrcIdx = 114;
	  section.data(42).dtTransOffset = 42;
	
	  ;% leader_qball2_mytest_DW.Origvadjustedroll_PWORK.LoggedData
	  section.data(43).logicalSrcIdx = 115;
	  section.data(43).dtTransOffset = 43;
	
	  ;% leader_qball2_mytest_DW.X_cmdandX_meas_PWORK.LoggedData
	  section.data(44).logicalSrcIdx = 116;
	  section.data(44).dtTransOffset = 44;
	
	  ;% leader_qball2_mytest_DW.Roll1_PWORK.LoggedData
	  section.data(45).logicalSrcIdx = 117;
	  section.data(45).dtTransOffset = 45;
	
	  ;% leader_qball2_mytest_DW.ToHostFile_PWORK
	  section.data(46).logicalSrcIdx = 118;
	  section.data(46).dtTransOffset = 46;
	
	  ;% leader_qball2_mytest_DW.throttlecmd_PWORK.LoggedData
	  section.data(47).logicalSrcIdx = 119;
	  section.data(47).dtTransOffset = 47;
	
	  ;% leader_qball2_mytest_DW.throttlesw_PWORK.LoggedData
	  section.data(48).logicalSrcIdx = 120;
	  section.data(48).dtTransOffset = 48;
	
	  ;% leader_qball2_mytest_DW.throttlejoystick_PWORK.LoggedData
	  section.data(49).logicalSrcIdx = 121;
	  section.data(49).dtTransOffset = 49;
	
	  ;% leader_qball2_mytest_DW.landwsonar_PWORK.LoggedData
	  section.data(50).logicalSrcIdx = 122;
	  section.data(50).dtTransOffset = 50;
	
	  ;% leader_qball2_mytest_DW.HeightPID_PWORK.LoggedData
	  section.data(51).logicalSrcIdx = 123;
	  section.data(51).dtTransOffset = 51;
	
	  ;% leader_qball2_mytest_DW.u_yaw_PWORK.LoggedData
	  section.data(52).logicalSrcIdx = 124;
	  section.data(52).dtTransOffset = 52;
	
	  ;% leader_qball2_mytest_DW.u_yaw1_PWORK.LoggedData
	  section.data(53).logicalSrcIdx = 125;
	  section.data(53).dtTransOffset = 53;
	
	  ;% leader_qball2_mytest_DW.yaw_error_PWORK.LoggedData
	  ...
	  ;% leader_qball2_mytest_DW.HILInitialize_DOStates
	  ...
	  ;% leader_qball2_mytest_DW.ToHostFile_SamplesCount
	  section.data(1).logicalSrcIdx = 128;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.ToHostFile_ArrayNameLength
	  ...
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK.IcNeedsLoading
	  section.data(1).logicalSrcIdx = 130;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK_j.IcNeedsLoading
	  section.data(2).logicalSrcIdx = 131;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK_o.IcNeedsLoading
	  section.data(3).logicalSrcIdx = 132;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK_l.IcNeedsLoading
	  section.data(4).logicalSrcIdx = 133;
	  section.data(4).dtTransOffset = 3;
	
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK_ov.IcNeedsLoading
	  ...
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK_b.IcNeedsLoading
	  section.data(7).logicalSrcIdx = 136;
	  section.data(7).dtTransOffset = 6;
	
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK_li.IcNeedsLoading
	  section.data(8).logicalSrcIdx = 137;
	  section.data(8).dtTransOffset = 7;
	
	  ;% leader_qball2_mytest_DW.Integrator1_IWORK_g.IcNeedsLoading
	  ...
	  ;% leader_qball2_mytest_DW.SwitchCase_ActiveSubsystem
	  ...
	  ;% leader_qball2_mytest_DW.ContinuousSigmoid_Flag
	  section.data(1).logicalSrcIdx = 157;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.SigmoidPath_Flag
	  ...
	  ;% leader_qball2_mytest_DW.HILInitialize_DOBits
	  section.data(1).logicalSrcIdx = 159;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.StreamClient_Connected
	  section.data(2).logicalSrcIdx = 160;
	  section.data(2).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_DW.InverseModulus_FirstSample
	  section.data(3).logicalSrcIdx = 161;
	  section.data(3).dtTransOffset = 3;
	
	  ;% leader_qball2_mytest_DW.HILWatchdog_IsStarted
	  ...
	  ;% leader_qball2_mytest_DW.HILReadWrite1_W_DigitalBuffer
	  ...
	  ;% leader_qball2_mytest_DW.EnabledMovingAverage_MODE
	  section.data(1).logicalSrcIdx = 164;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.EnabledSubsystem_MODE
	  section.data(2).logicalSrcIdx = 165;
	  section.data(2).dtTransOffset = 1;
	
	  ;% leader_qball2_mytest_DW.EnabledSubsystem_MODE_h
	  section.data(3).logicalSrcIdx = 166;
	  section.data(3).dtTransOffset = 2;
	
	  ;% leader_qball2_mytest_DW.armheightcommand_MODE
	  ...
	  ;% leader_qball2_mytest_DW.EnabledSubsystem1_b.DiscreteTimeIntegrator_DSTATE
	  ...
	  ;% leader_qball2_mytest_DW.EnabledSubsystem1_b.EnabledSubsystem1_MODE
	  ...
	  ;% leader_qball2_mytest_DW.EnabledSubsystem1.DiscreteTimeIntegrator_DSTATE
	  section.data(1).logicalSrcIdx = 171;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% leader_qball2_mytest_DW.EnabledSubsystem1.EnabledSubsystem1_MODE
	  ...
	  ;% leader_qball2_mytest_DW.EnabledMovingAverage_e.UnitDelay_DSTATE
	  section.data(1).logicalSrcIdx = 174;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.EnabledMovingAverage_e.Sumk1n1xk_DSTATE
	  ...
	  ;% leader_qball2_mytest_DW.EnabledMovingAverage_e.EnabledMovingAverage_MODE
	  ...
	  ;% leader_qball2_mytest_DW.EnabledMovingAverage_c.UnitDelay_DSTATE
	  section.data(1).logicalSrcIdx = 178;
	  section.data(1).dtTransOffset = 0;
	
	  ;% leader_qball2_mytest_DW.EnabledMovingAverage_c.Sumk1n1xk_DSTATE
	  ...
	  ;% leader_qball2_mytest_DW.EnabledMovingAverage_c.EnabledMovingAverage_MODE
  ...
  targMap.checksum0 = 112178149;
  targMap.checksum1 = 365111478;
  targMap.checksum2 = 3125634437;
  targMap.checksum3 = 4112400441;
