 ...
 */
#ifndef RTW_HEADER_leader_qball2_h_
#define RTW_HEADER_leader_qball2_h_
#include <math.h>
#include <float.h>
#include <string.h>
#ifndef leader_qball2_COMMON_INCLUDES_
# define leader_qball2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* leader_qball2_COMMON_INCLUDES_ */

#include "leader_qball2_types.h"
...
typedef struct {
  ...
  real_T wn_p;                         /* '<S135>/wn' */
  real_T Product1_n;                   /* '<S135>/Product1' */
  real_T SwitchKd;                     /* '<S127>/Switch - Kd' */
  real_T vmaxtakeoff;                  /* '<S131>/vmax takeoff' */
  real_T amaxtakeoff;                  /* '<S131>/amax takeoff' */
  real_T Constant_m;                   /* '<S132>/Constant' */
  real_T Constant_es;                  /* '<S125>/Constant' */
  ...
  real_T Constant_g;                   /* '<S112>/Constant' */
  real_T Constant_j;                   /* '<S133>/Constant' */
  real_T vmaxflight;                   /* '<S131>/vmax flight' */
  real_T amaxflight;                   /* '<S131>/amax flight' */
  real_T ContinuousSigmoid_o1;         /* '<S126>/Continuous Sigmoid' */
  real_T ContinuousSigmoid_o2;         /* '<S126>/Continuous Sigmoid' */
  real_T ContinuousSigmoid_o3;         /* '<S126>/Continuous Sigmoid' */
  real_T ContinuousSigmoid_o4;         /* '<S126>/Continuous Sigmoid' */
  real_T SwitchKp;                     /* '<S127>/Switch - Kp' */
  real_T Memory;                       /* '<S134>/Memory' */
  real_T Integrator_a;                 /* '<S127>/Integrator' */
  real_T Constant1_l;                  /* '<S127>/Constant1' */
  real_T ThrottleTrim;                 /* '<S7>/Throttle Trim' */
  real_T Constant_ov;                  /* '<S127>/Constant' */
  real_T heightcommand1;               /* '<S113>/height command1' */
  real_T heightcommand2;               /* '<S113>/height command2' */
  real_T Switch;                       /* '<S11>/Switch' */
  real_T Constant1_o;                  /* '<S118>/Constant1' */
  real_T landthrottletarget;           /* '<S118>/land throttle target' */
  real_T SigmoidPath_o1;               /* '<S120>/Sigmoid Path' */
  real_T SigmoidPath_o2;               /* '<S120>/Sigmoid Path' */
  real_T SigmoidPath_o3;               /* '<S120>/Sigmoid Path' */
  real_T SigmoidPath_o4;               /* '<S120>/Sigmoid Path' */
  real_T ManualSwitch_a;               /* '<S119>/Manual Switch' */
  real_T Switch_e;                     /* '<S114>/Switch' */
  real_T Constant_h;                   /* '<S137>/Constant' */
  real_T Sum5;                         /* '<S13>/Sum5' */
  real_T ManualSwitch4;                /* '<S5>/Manual Switch4' */
  real_T SliderGain_o;                 /* '<S139>/Slider Gain' */
  ...
  real_T Sum_n;                        /* '<S2>/Sum' */
  real_T Sum1;                         /* '<S2>/Sum1' */
  real_T SwitchKd_m;                   /* '<S93>/Switch - Kd' */
  real_T Memory_f;                     /* '<S99>/Memory' */
  real_T Switch_f;                     /* '<S97>/Switch' */
  real_T ManualSwitch_j;               /* '<S8>/Manual Switch' */
  real_T SwitchKp_f;                   /* '<S93>/Switch - Kp' */
  real_T Constant_n;                   /* '<S95>/Constant' */
  real_T Integrator1_n;                /* '<S93>/Integrator1' */
  real_T roll_trim;                    /* '<S7>/roll_trim' */
  real_T Sum_ng;                       /* '<S93>/Sum' */
  real_T Sum2;                         /* '<S2>/Sum2' */
  real_T Sum3;                         /* '<S2>/Sum3' */
  ...
  real_T SwitchKp_c;                   /* '<S86>/Switch - Kp' */
  real_T Product_c;                    /* '<S82>/Product' */
  real_T wn_a5;                        /* '<S103>/wn' */
  real_T Product1_d;                   /* '<S103>/Product1' */
  real_T SwitchKd_o;                   /* '<S100>/Switch - Kd' */
  real_T RateLimiter1;                 /* '<S7>/Rate Limiter1' */
  real_T SwitchKp_cx;                  /* '<S100>/Switch - Kp' */
  ...
  real_T SwitchKi_i;                   /* '<S93>/Switch - Ki' */
  real_T Product_n;                    /* '<S96>/Product' */
  real_T Constant_c;                   /* '<S103>/Constant' */
  real_T x0_i;                         /* '<S103>/x0' */
  real_T zt_g;                         /* '<S103>/zt' */
  real_T Product_j;                    /* '<S103>/Product' */
  real_T SwitchKi_b;                   /* '<S100>/Switch - Ki' */
  real_T Gain1_k[4];                   /* '<S8>/Gain1' */
  real_T DataTypeConversion;           /* '<S108>/Data Type Conversion' */
  real_T DataTypeConversion1;          /* '<S108>/Data Type Conversion1' */
  real_T DataTypeConversion2;          /* '<S108>/Data Type Conversion2' */
  real_T DataTypeConversion3;          /* '<S108>/Data Type Conversion3' */
  real_T Constant_gl;                  /* '<S135>/Constant' */
  real_T x0_g;                         /* '<S135>/x0' */
  real_T zt_m;                         /* '<S135>/zt' */
  real_T Product_lu;                   /* '<S135>/Product' */
  real_T SwitchKi_n;                   /* '<S127>/Switch - Ki' */
  real_T SwitchKi_ih;                  /* '<S13>/Switch - Ki' */
  real_T land;                         /* '<S127>/User-controller landing state machine' */
  real_T In1;                          /* '<S130>/In1' */
  real_T Constant_hf;                  /* '<S129>/Constant' */
  real_T SigmoidCompute_o1[11];        /* '<S121>/Sigmoid Compute' */
  real_T enable;                       /* '<S112>/MATLAB Function' */
  real_T Constant_k;                   /* '<S104>/Constant' */
  real_T adj_roll_cmd;                 /* '<S99>/adjust_roll_command' */
  ...
  int8_T SigmoidCompute_o2;            /* '<S121>/Sigmoid Compute' */
  ...
  boolean_T LogicalOperator2_o;        /* '<S134>/Logical Operator2' */
  boolean_T Compare_i;                 /* '<S123>/Compare' */
  boolean_T LogicalOperator_b;         /* '<S119>/Logical Operator' */
  boolean_T LogicalOperator_a;         /* '<S114>/Logical Operator' */
  boolean_T Compare_h;                 /* '<S137>/Compare' */
  boolean_T LogicalOperator_m;         /* '<S16>/Logical Operator' */
  boolean_T Compare_f;                 /* '<S91>/Compare' */
  boolean_T Compare_n;                 /* '<S95>/Compare' */
  ...
  boolean_T LogicalOperator1_h;        /* '<S102>/Logical Operator1' */
  ...
  B_EnabledSubsystem1_leader_qb_T EnabledSubsystem1_b;/* '<S119>/Enabled Subsystem1' */
...
typedef struct {
  ...
  real_T ContinuousSigmoid_Sigmoid[11];/* '<S126>/Continuous Sigmoid' */
  real_T Memory_PreviousInput_p;       /* '<S134>/Memory' */
  real_T SigmoidPath_Path[11];         /* '<S120>/Sigmoid Path' */
  real_T SigmoidPath_NewPath[11];      /* '<S120>/Sigmoid Path' */
  real_T TimeStampA_e;                 /* '<S119>/Derivative' */
  real_T LastUAtTimeA_a;               /* '<S119>/Derivative' */
  real_T TimeStampB_c;                 /* '<S119>/Derivative' */
  real_T LastUAtTimeB_l;               /* '<S119>/Derivative' */
  real_T Memory_PreviousInput_i;       /* '<S85>/Memory' */
  real_T Memory_PreviousInput_j;       /* '<S99>/Memory' */
  ...
  real_T state;                        /* '<S127>/User-controller landing state machine' */
  real_T c;                            /* '<S127>/User-controller landing state machine' */
  real_T state_h;                      /* '<S112>/MATLAB Function' */
  real_T counter;                      /* '<S112>/MATLAB Function' */
  ...
  struct {
    ...
    real_T PPos;
    real_T PVel;
  } ContinuousSigmoid_RWORK;           /* '<S126>/Continuous Sigmoid' */

  struct {
    real_T Time;
  } SigmoidPath_RWORK;                 /* '<S120>/Sigmoid Path' */
  ...
  struct {
    void *LoggedData;
  } Origvadjustedroll_PWORK;           /* '<S96>/Orig v. adjusted roll' */

  struct {
    void *LoggedData;
  } X_cmdandX_meas_PWORK;              /* '<S96>/X_cmd and X_meas' */
  ...
  struct {
    void *LoggedData;
  } throttlejoystick_PWORK;            /* '<S113>/throttle joystick' */

  struct {
    void *LoggedData;
  } landwsonar_PWORK;                  /* '<S114>/land w// sonar' */

  struct {
    void *LoggedData;
  } HeightPID_PWORK;                   /* '<S127>/Height P I D' */
  ...
  struct {
    int_T IcNeedsLoading;
  } Integrator1_IWORK_li;              /* '<S103>/Integrator1' */

  struct {
    int_T IcNeedsLoading;
  } Integrator1_IWORK_g;               /* '<S135>/Integrator1' */
  ...
  int8_T EnabledSubsystem_SubsysRanBC_l;/* '<S125>/Enabled Subsystem' */
  int8_T SigmoidPath_Toggle;           /* '<S120>/Sigmoid Path' */
  int8_T EnabledSubsystem_SubsysRanBC_d;/* '<S16>/Enabled Subsystem' */
  int8_T EnabledSubsystem_SubsysRanBC_h;/* '<S83>/Enabled Subsystem' */
  int8_T EnabledSubsystem_SubsysRanBC_f;/* '<S97>/Enabled Subsystem' */
  int8_T EnabledSubsystem_SubsysRanBC_m;/* '<S20>/Enabled Subsystem' */
  int8_T TriggeredSigmoidCompute_SubsysR;/* '<S120>/Triggered Sigmoid Compute' */
  int8_T armheightcommand_SubsysRanBC; /* '<S126>/arm height command' */
  int8_T SigmoidCompute_Toggle;        /* '<S121>/Sigmoid Compute' */
  ...
  uint8_T ContinuousSigmoid_Flag;      /* '<S126>/Continuous Sigmoid' */
  uint8_T SigmoidPath_Flag;            /* '<S120>/Sigmoid Path' */
  ...
  boolean_T armheightcommand_MODE;     /* '<S126>/arm height command' */
  DW_EnabledSubsystem1_leader_q_T EnabledSubsystem1_b;/* '<S119>/Enabled Subsystem1' */
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_e;         /* '<S135>/Integrator2' */
  real_T Integrator_CSTATE_ga;         /* '<S127>/Integrator' */
  ...
  real_T LowPassFilterFilteredRollRate_C;/* '<S93>/Low Pass Filter (Filtered Roll Rate)' */
  real_T Integrator1_CSTATE_n;         /* '<S93>/Integrator1' */
  real_T Integrator2_CSTATE_ir;        /* '<S89>/Integrator2' */
  real_T Integrator_CSTATE_k;          /* '<S86>/Integrator' */
  real_T Integrator2_CSTATE_a;         /* '<S103>/Integrator2' */
  real_T Integrator1_CSTATE_nx;        /* '<S100>/Integrator1' */
  real_T Integrator1_CSTATE_c;         /* '<S89>/Integrator1' */
  real_T Integrator1_CSTATE_e;         /* '<S103>/Integrator1' */
  real_T Integrator1_CSTATE_d;         /* '<S135>/Integrator1' */
} X_leader_qball2_T;
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_e;      /* '<S135>/Integrator2' */
  boolean_T Integrator_CSTATE_ga;      /* '<S127>/Integrator' */
  ...
  boolean_T LowPassFilterFilteredRollRate_C;/* '<S93>/Low Pass Filter (Filtered Roll Rate)' */
  boolean_T Integrator1_CSTATE_n;      /* '<S93>/Integrator1' */
  boolean_T Integrator2_CSTATE_ir;     /* '<S89>/Integrator2' */
  boolean_T Integrator_CSTATE_k;       /* '<S86>/Integrator' */
  boolean_T Integrator2_CSTATE_a;      /* '<S103>/Integrator2' */
  boolean_T Integrator1_CSTATE_nx;     /* '<S100>/Integrator1' */
  boolean_T Integrator1_CSTATE_c;      /* '<S89>/Integrator1' */
  boolean_T Integrator1_CSTATE_e;      /* '<S103>/Integrator1' */
  boolean_T Integrator1_CSTATE_d;      /* '<S135>/Integrator1' */
} XDis_leader_qball2_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator_Reset_ZCE;     /* '<S127>/Integrator' */
  ZCSigState Integrator_Reset_ZCE_f;   /* '<S13>/Integrator' */
  ZCSigState Integrator1_Reset_ZCE;    /* '<S81>/Integrator1' */
  ZCSigState Integrator1_Reset_ZCE_e;  /* '<S93>/Integrator1' */
  ZCSigState Integrator_Reset_ZCE_n;   /* '<S86>/Integrator' */
  ZCSigState Integrator1_Reset_ZCE_f;  /* '<S100>/Integrator1' */
  ZCSigState TriggeredSigmoidCompute_Trig_ZC;/* '<S120>/Triggered Sigmoid Compute' */
  ZCSigState TriggeredSubsystem_Trig_ZCE;/* '<S55>/Triggered Subsystem' */
} PrevZCX_leader_qball2_T;
...
struct P_leader_qball2_T_ {
  real_T KdHEIGHT_DOWN;                /* Variable: KdHEIGHT_DOWN
                                        * Referenced by: '<S127>/Kd - Battery DOWN'
                                        */
  real_T KdHEIGHT_UP;                  /* Variable: KdHEIGHT_UP
                                        * Referenced by: '<S127>/Kd - Battery UP'
                                        */
  ...
  real_T KdOUTER_ROLL_DOWN;            /* Variable: KdOUTER_ROLL_DOWN
                                        * Referenced by: '<S100>/Kv - DOWN'
                                        */
  real_T KdOUTER_ROLL_UP;              /* Variable: KdOUTER_ROLL_UP
                                        * Referenced by: '<S100>/Kv - UP'
                                        */
  ...
  real_T KdROLL_DOWN;                  /* Variable: KdROLL_DOWN
                                        * Referenced by: '<S93>/Kd - Battery DOWN'
                                        */
  real_T KdROLL_UP;                    /* Variable: KdROLL_UP
                                        * Referenced by: '<S93>/Kd - Battery UP'
                                        */
  ...
  real_T KiHEIGHT_DOWN;                /* Variable: KiHEIGHT_DOWN
                                        * Referenced by: '<S127>/Ki - Battery DOWN'
                                        */
  real_T KiHEIGHT_UP;                  /* Variable: KiHEIGHT_UP
                                        * Referenced by: '<S127>/Ki - Battery UP'
                                        */
  ...
  real_T KiOUTER_ROLL_DOWN;            /* Variable: KiOUTER_ROLL_DOWN
                                        * Referenced by: '<S100>/Ki - Battery DOWN'
                                        */
  real_T KiOUTER_ROLL_UP;              /* Variable: KiOUTER_ROLL_UP
                                        * Referenced by: '<S100>/Ki - Battery UP'
                                        */
  ...
  real_T KiROLL_DOWN;                  /* Variable: KiROLL_DOWN
                                        * Referenced by: '<S93>/Ki - Battery DOWN'
                                        */
  real_T KiROLL_UP;                    /* Variable: KiROLL_UP
                                        * Referenced by: '<S93>/Ki - Battery UP'
                                        */
  ...
  real_T KpHEIGHT_DOWN;                /* Variable: KpHEIGHT_DOWN
                                        * Referenced by: '<S127>/Kp - Battery DOWN'
                                        */
  real_T KpHEIGHT_UP;                  /* Variable: KpHEIGHT_UP
                                        * Referenced by: '<S127>/Kp - Battery UP'
                                        */
  ...
  real_T KpOUTER_ROLL_DOWN;            /* Variable: KpOUTER_ROLL_DOWN
                                        * Referenced by: '<S100>/Kp - Battery DOWN'
                                        */
  real_T KpOUTER_ROLL_UP;              /* Variable: KpOUTER_ROLL_UP
                                        * Referenced by: '<S100>/Kp - Battery UP'
                                        */
  ...
  real_T KpROLL_DOWN;                  /* Variable: KpROLL_DOWN
                                        * Referenced by: '<S93>/Kp - Battery DOWN'
                                        */
  real_T KpROLL_UP;                    /* Variable: KpROLL_UP
                                        * Referenced by: '<S93>/Kp - Battery UP'
                                        */
  ...
  real_T joystick_range_max;           /* Variable: joystick_range_max
                                        * Referenced by: '<S113>/height command2'
                                        */
  real_T joystick_range_min;           /* Variable: joystick_range_min
                                        * Referenced by: '<S113>/height command1'
                                        */
  ...
  real_T Joystickyawcommandgain1_gain; /* Mask Parameter: Joystickyawcommandgain1_gain
                                        * Referenced by: '<S140>/Slider Gain'
                                        */
  ...
  real_T JoystickSensitivity_Gain_j;   /* Expression: 0.15
                                        * Referenced by: '<S94>/Joystick Sensitivity'
                                        */
  ...
  real_T Joystickthrottlescaling_Gain; /* Expression: 0.8
                                        * Referenced by: '<S113>/Joystick throttle scaling'
                                        */
  ...
  real_T Integrator2_IC_kr;            /* Expression: 0
                                        * Referenced by: '<S135>/Integrator2'
                                        */
  real_T SwitchKd_Threshold_p;         /* Expression: 0.5
                                        * Referenced by: '<S127>/Switch - Kd'
                                        */
  real_T vmaxtakeoff_Value;            /* Expression: 2
                                        * Referenced by: '<S131>/vmax takeoff'
                                        */
  real_T amaxtakeoff_Value;            /* Expression: 0.2
                                        * Referenced by: '<S131>/amax takeoff'
                                        */
  ...
  real_T vmaxflight_Value;             /* Expression: 2
                                        * Referenced by: '<S131>/vmax flight'
                                        */
  real_T amaxflight_Value;             /* Expression: 10
                                        * Referenced by: '<S131>/amax flight'
                                        */
  real_T SwitchKp_Threshold_c;         /* Expression: 0.5
                                        * Referenced by: '<S127>/Switch - Kp'
                                        */
  ...
  real_T landthrottletarget_Value;     /* Expression: 0
                                        * Referenced by: '<S118>/land throttle target'
                                        */
  ...
  real_T LowPassFilterFilteredRollRate_A;/* Computed Parameter: LowPassFilterFilteredRollRate_A
                                          * Referenced by: '<S93>/Low Pass Filter (Filtered Roll Rate)'
                                          */
  ...
  real_T Integrator2_IC_h;             /* Expression: 0
                                        * Referenced by: '<S103>/Integrator2'
                                        */
  real_T SwitchKd_Threshold_g;         /* Expression: 0.5
                                        * Referenced by: '<S100>/Switch - Kd'
                                        */
  ...
  uint8_T ManualSwitch_CurrentSetting_m;/* Computed Parameter: ManualSwitch_CurrentSetting_m
                                         * Referenced by: '<S115>/Manual Switch'
                                         */
  ...
  uint8_T ManualSwitch_CurrentSetting_h;/* Computed Parameter: ManualSwitch_CurrentSetting_h
                                         * Referenced by: '<S93>/Manual Switch'
                                         */
  ...
  boolean_T StreamServer_Active;       /* Computed Parameter: StreamServer_Active
                                        * Referenced by: '<S10>/Stream Server'
                                        */
  P_EnabledSubsystem1_leader_qb_T EnabledSubsystem1_b;/* '<S119>/Enabled Subsystem1' */
...
struct tag_RTM_leader_qball2_T {
...
extern P_leader_qball2_T leader_qball2_P;

/* Block signals (auto storage) */
extern B_leader_qball2_T leader_qball2_B;

/* Continuous states (auto storage) */
extern X_leader_qball2_T leader_qball2_X;

/* Block states (auto storage) */
extern DW_leader_qball2_T leader_qball2_DW;

/* External data declarations for dependent source files */

/* Zero-crossing (trigger) state */
extern PrevZCX_leader_qball2_T leader_qball2_PrevZCX;

/* Model entry point functions */
extern void leader_qball2_initialize(void);
extern void leader_qball2_step0(void);
extern void leader_qball2_step(int_T tid);
extern void leader_qball2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_leader_qball2_T *const leader_qball2_M;
 ...
 *
 * '<Root>' : 'leader_qball2'
 * '<S1>'   : 'leader_qball2/Calculate Roll Pitch'
 * '<S2>'   : 'leader_qball2/Control signal mixing'
 * '<S3>'   : 'leader_qball2/DAQ'
 * '<S4>'   : 'leader_qball2/Data from host'
 * '<S5>'   : 'leader_qball2/Mode control'
 * '<S6>'   : 'leader_qball2/Pitch Controller'
 * '<S7>'   : 'leader_qball2/Position Commands'
 * '<S8>'   : 'leader_qball2/Roll Controller'
 * '<S9>'   : 'leader_qball2/SAVE DATA (black box)'
 * '<S10>'  : 'leader_qball2/Serve Data For Follower'
 * '<S11>'  : 'leader_qball2/Throttle and height control'
 * '<S12>'  : 'leader_qball2/URI Definitions'
 * '<S13>'  : 'leader_qball2/Yaw Controller'
 * '<S14>'  : 'leader_qball2/Calculate Roll Pitch/Calculate Pitch'
 * '<S15>'  : 'leader_qball2/Calculate Roll Pitch/Calculate Roll'
 * '<S16>'  : 'leader_qball2/Control signal mixing/Safety - Motor Shutoff if: - Roll//Pitch Data Runaway (> 40 deg) - Initial 3 second of execution for motor initialization'
 * '<S17>'  : 'leader_qball2/Control signal mixing/Safety - Motor Shutoff if: - Roll//Pitch Data Runaway (> 40 deg) - Initial 3 second of execution for motor initialization/Compare To Constant1'
 * '<S18>'  : 'leader_qball2/Control signal mixing/Safety - Motor Shutoff if: - Roll//Pitch Data Runaway (> 40 deg) - Initial 3 second of execution for motor initialization/Compare To Constant2'
 * '<S19>'  : 'leader_qball2/Control signal mixing/Safety - Motor Shutoff if: - Roll//Pitch Data Runaway (> 40 deg) - Initial 3 second of execution for motor initialization/Enabled Subsystem'
 * '<S20>'  : 'leader_qball2/Control signal mixing/Safety - Motor Shutoff if: - Roll//Pitch Data Runaway (> 40 deg) - Initial 3 second of execution for motor initialization/throttle enable'
 * '<S21>'  : 'leader_qball2/Control signal mixing/Safety - Motor Shutoff if: - Roll//Pitch Data Runaway (> 40 deg) - Initial 3 second of execution for motor initialization/throttle enable/Compare To Constant'
 * '<S22>'  : 'leader_qball2/Control signal mixing/Safety - Motor Shutoff if: - Roll//Pitch Data Runaway (> 40 deg) - Initial 3 second of execution for motor initialization/throttle enable/Enabled Subsystem'
 * '<S23>'  : 'leader_qball2/DAQ/Initialize sensors'
 * '<S24>'  : 'leader_qball2/DAQ/Low battery check'
 * '<S25>'  : 'leader_qball2/DAQ/spike detection'
 * '<S26>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data'
 * '<S27>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate accelerometer (Obsolete)'
 * '<S28>'  : 'leader_qball2/DAQ/Initialize sensors/Nonlinear Limit (Reject Spikes)'
 * '<S29>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering'
 * '<S30>'  : 'leader_qball2/DAQ/Initialize sensors/Zero gyro'
 * '<S31>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/Bias Removal'
 * '<S32>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/Second-Order Low-Pass Filter2'
 * '<S33>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/correct accel mounting'
 * '<S34>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/Bias Removal/Enabled Moving Average'
 * '<S35>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/Bias Removal/Switch Case Action Subsystem'
 * '<S36>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/Bias Removal/Switch Case Action Subsystem1'
 * '<S37>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/Bias Removal/Switch Case Action Subsystem2'
 * '<S38>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate Accelerometer Data/Bias Removal/Enabled Moving Average/Increment'
 * '<S39>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate accelerometer (Obsolete)/Enabled Moving Average'
 * '<S40>'  : 'leader_qball2/DAQ/Initialize sensors/Calibrate accelerometer (Obsolete)/Enabled Moving Average/Increment'
 * '<S41>'  : 'leader_qball2/DAQ/Initialize sensors/Nonlinear Limit (Reject Spikes)/Embedded MATLAB Function'
 * '<S42>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Calculate Roll and Pitch (From Acceleration Data)'
 * '<S43>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Kalman Filter - Height'
 * '<S44>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Kalman Filter - Pitch'
 * '<S45>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Kalman Filter - Roll'
 * '<S46>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Kalman Filter - Yaw'
 * '<S47>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Second-Order Low-Pass Filter3'
 * '<S48>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Second-Order Low-Pass Filter4'
 * '<S49>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Second-Order Low-Pass Filter5'
 * '<S50>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Second-Order Low-Pass Filter7'
 * '<S51>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Signal Conditioning - Sonar'
 * '<S52>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Calculate Roll and Pitch (From Acceleration Data)/calc_roll_pitch'
 * '<S53>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Calculate Roll and Pitch (From Acceleration Data)/calc_roll_pitch_asin'
 * '<S54>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Signal Conditioning - Sonar/FOH1'
 * '<S55>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Signal Conditioning - Sonar/Sampler'
 * '<S56>'  : 'leader_qball2/DAQ/Initialize sensors/Sensor Fusion//Filtering/Signal Conditioning - Sonar/Sampler/Triggered Subsystem'
 * '<S57>'  : 'leader_qball2/DAQ/Initialize sensors/Zero gyro/Enabled Moving Average'
 * '<S58>'  : 'leader_qball2/DAQ/Initialize sensors/Zero gyro/Enabled Moving Average/Increment'
 * '<S59>'  : 'leader_qball2/DAQ/Low battery check/Compare To Constant'
 * '<S60>'  : 'leader_qball2/DAQ/spike detection/Compare To Constant'
 * '<S61>'  : 'leader_qball2/Data from host/Subsystem4'
 * '<S62>'  : 'leader_qball2/Data from host/Subsystem5'
 * '<S63>'  : 'leader_qball2/Data from host/Subsystem6'
 * '<S64>'  : 'leader_qball2/Data from host/Subsystem7'
 * '<S65>'  : 'leader_qball2/Data from host/rcvd packet monitoring'
 * '<S66>'  : 'leader_qball2/Data from host/timeout safety'
 * '<S67>'  : 'leader_qball2/Data from host/Subsystem4/Embedded MATLAB Function'
 * '<S68>'  : 'leader_qball2/Data from host/Subsystem5/Embedded MATLAB Function'
 * '<S69>'  : 'leader_qball2/Data from host/Subsystem6/Embedded MATLAB Function'
 * '<S70>'  : 'leader_qball2/Data from host/Subsystem7/Compare To Constant'
 * '<S71>'  : 'leader_qball2/Data from host/Subsystem7/Compare To Constant1'
 * '<S72>'  : 'leader_qball2/Data from host/rcvd packet monitoring/spike detection'
 * '<S73>'  : 'leader_qball2/Data from host/rcvd packet monitoring/spike detection/Compare To Constant'
 * '<S74>'  : 'leader_qball2/Data from host/timeout safety/Compare To Constant'
 * '<S75>'  : 'leader_qball2/Data from host/timeout safety/Compare To Constant1'
 * '<S76>'  : 'leader_qball2/Data from host/timeout safety/Enabled Subsystem'
 * '<S77>'  : 'leader_qball2/Data from host/timeout safety/Enabled Subsystem1'
 * '<S78>'  : 'leader_qball2/Data from host/timeout safety/Enabled Subsystem2'
 * '<S79>'  : 'leader_qball2/Data from host/timeout safety/Enabled Subsystem Latch Output High'
 * '<S80>'  : 'leader_qball2/Pitch Controller/Subsystem'
 * '<S81>'  : 'leader_qball2/Pitch Controller/pitch controller'
 * '<S82>'  : 'leader_qball2/Pitch Controller/Subsystem/OT pos control'
 * '<S83>'  : 'leader_qball2/Pitch Controller/Subsystem/Safety - Emergency Landing Zero Ref CMD'
 * '<S84>'  : 'leader_qball2/Pitch Controller/Subsystem/OT pos control/Compare To Constant'
 * '<S85>'  : 'leader_qball2/Pitch Controller/Subsystem/OT pos control/adjust_for_heading'
 * '<S86>'  : 'leader_qball2/Pitch Controller/Subsystem/OT pos control/rate limitted control'
 * '<S87>'  : 'leader_qball2/Pitch Controller/Subsystem/OT pos control/adjust_for_heading/adjust_pitch_command'
 * '<S88>'  : 'leader_qball2/Pitch Controller/Subsystem/OT pos control/rate limitted control/Integrator reset'
 * '<S89>'  : 'leader_qball2/Pitch Controller/Subsystem/OT pos control/rate limitted control/Second-Order Low-Pass Filter1'
 * '<S90>'  : 'leader_qball2/Pitch Controller/Subsystem/Safety - Emergency Landing Zero Ref CMD/Enabled Subsystem'
 * '<S91>'  : 'leader_qball2/Pitch Controller/pitch controller/Compare To Constant'
 * '<S92>'  : 'leader_qball2/Position Commands/Slider Gain'
 * '<S93>'  : 'leader_qball2/Roll Controller/Roll Controller'
 * '<S94>'  : 'leader_qball2/Roll Controller/Subsystem'
 * '<S95>'  : 'leader_qball2/Roll Controller/Roll Controller/Compare To Constant'
 * '<S96>'  : 'leader_qball2/Roll Controller/Subsystem/OT pos control'
 * '<S97>'  : 'leader_qball2/Roll Controller/Subsystem/Safety - Emergency Landing Zero Ref CMD'
 * '<S98>'  : 'leader_qball2/Roll Controller/Subsystem/OT pos control/Compare To Constant'
 * '<S99>'  : 'leader_qball2/Roll Controller/Subsystem/OT pos control/adjust_for_heading'
 * '<S100>' : 'leader_qball2/Roll Controller/Subsystem/OT pos control/rate limitted control'
 * '<S101>' : 'leader_qball2/Roll Controller/Subsystem/OT pos control/adjust_for_heading/adjust_roll_command'
 * '<S102>' : 'leader_qball2/Roll Controller/Subsystem/OT pos control/rate limitted control/Integrator reset'
 * '<S103>' : 'leader_qball2/Roll Controller/Subsystem/OT pos control/rate limitted control/Second-Order Low-Pass Filter1'
 * '<S104>' : 'leader_qball2/Roll Controller/Subsystem/Safety - Emergency Landing Zero Ref CMD/Enabled Subsystem'
 * '<S105>' : 'leader_qball2/SAVE DATA (black box)/Signals 1-10'
 * '<S106>' : 'leader_qball2/SAVE DATA (black box)/Signals 11-20'
 * '<S107>' : 'leader_qball2/SAVE DATA (black box)/Signals 21-30'
 * '<S108>' : 'leader_qball2/SAVE DATA (black box)/Signals 31-40'
 * '<S109>' : 'leader_qball2/SAVE DATA (black box)/Signals 41-50'
 * '<S110>' : 'leader_qball2/SAVE DATA (black box)/Signals 51-60'
 * '<S111>' : 'leader_qball2/SAVE DATA (black box)/Signals 61-70'
 * '<S112>' : 'leader_qball2/Throttle and height control/Height joystick adjust'
 * '<S113>' : 'leader_qball2/Throttle and height control/Joystick mode throttle'
 * '<S114>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed '
 * '<S115>' : 'leader_qball2/Throttle and height control/height control'
 * '<S116>' : 'leader_qball2/Throttle and height control/Height joystick adjust/MATLAB Function'
 * '<S117>' : 'leader_qball2/Throttle and height control/Joystick mode throttle/Joystick to Throttle  Mapping'
 * '<S118>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed /Limit descent rate'
 * '<S119>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed /Subsystem'
 * '<S120>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed /Limit descent rate/Triggered Sigmoid'
 * '<S121>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed /Limit descent rate/Triggered Sigmoid/Triggered Sigmoid Compute'
 * '<S122>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed /Subsystem/Compare To Constant'
 * '<S123>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed /Subsystem/Compare To Zero'
 * '<S124>' : 'leader_qball2/Throttle and height control/Safety - Active During Emergency Landing: Ramp Throttle CMD down to zero if Sonar Failed /Subsystem/Enabled Subsystem1'
 * '<S125>' : 'leader_qball2/Throttle and height control/height control/Safety - Emergency Landing (Set Height Ref CMD to zero)'
 * '<S126>' : 'leader_qball2/Throttle and height control/height control/sigmoid1'
 * '<S127>' : 'leader_qball2/Throttle and height control/height control/sonar controller'
 * '<S128>' : 'leader_qball2/Throttle and height control/height control/sonar height'
 * '<S129>' : 'leader_qball2/Throttle and height control/height control/Safety - Emergency Landing (Set Height Ref CMD to zero)/Enabled Subsystem'
 * '<S130>' : 'leader_qball2/Throttle and height control/height control/sigmoid1/arm height command'
 * '<S131>' : 'leader_qball2/Throttle and height control/height control/sigmoid1/sigmoid limits'
 * '<S132>' : 'leader_qball2/Throttle and height control/height control/sigmoid1/sigmoid limits/Compare To Constant'
 * '<S133>' : 'leader_qball2/Throttle and height control/height control/sigmoid1/sigmoid limits/Compare To Constant1'
 * '<S134>' : 'leader_qball2/Throttle and height control/height control/sonar controller/Integrator reset'
 * '<S135>' : 'leader_qball2/Throttle and height control/height control/sonar controller/Second-Order Low-Pass Filter'
 * '<S136>' : 'leader_qball2/Throttle and height control/height control/sonar controller/User-controller landing state machine'
 * '<S137>' : 'leader_qball2/Yaw Controller/Compare To Constant'
 * '<S138>' : 'leader_qball2/Yaw Controller/Joystick yaw  control gain'
 * '<S139>' : 'leader_qball2/Yaw Controller/Joystick yaw command gain'
 * '<S140>' : 'leader_qball2/Yaw Controller/Joystick yaw command gain1'
 */
#endif                                 /* RTW_HEADER_leader_qball2_h_ */
