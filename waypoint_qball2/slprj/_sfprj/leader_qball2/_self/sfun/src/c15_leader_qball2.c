...
static void initialize_c15_leader_qball2(SFc15_leader_qball2InstanceStruct
  *chartInstance);
static void initialize_params_c15_leader_qball2
  (SFc15_leader_qball2InstanceStruct *chartInstance);
static void enable_c15_leader_qball2(SFc15_leader_qball2InstanceStruct
  *chartInstance);
static void disable_c15_leader_qball2(SFc15_leader_qball2InstanceStruct
  *chartInstance);
static void c15_update_debugger_state_c15_leader_qball2
  (SFc15_leader_qball2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_leader_qball2
  (SFc15_leader_qball2InstanceStruct *chartInstance);
static void set_sim_state_c15_leader_qball2(SFc15_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c15_st);
static void finalize_c15_leader_qball2(SFc15_leader_qball2InstanceStruct
  *chartInstance);
static void sf_gateway_c15_leader_qball2(SFc15_leader_qball2InstanceStruct
  *chartInstance);
static void initSimStructsc15_leader_qball2(SFc15_leader_qball2InstanceStruct
  *chartInstance);
...
static const mxArray *c15_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static real_T c15_emlrt_marshallIn(SFc15_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c15_adj_pitch_cmd, const char_T *c15_identifier);
static real_T c15_b_emlrt_marshallIn(SFc15_leader_qball2InstanceStruct
...
static const mxArray *c15_b_sf_marshallOut(void *chartInstanceVoid, void
  *c15_inData);
static int32_T c15_c_emlrt_marshallIn(SFc15_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c15_mxArrayInData, const char_T *c15_varName, void *c15_outData);
static uint8_T c15_d_emlrt_marshallIn(SFc15_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_leader_qball2, const char_T
  *c15_identifier);
static uint8_T c15_e_emlrt_marshallIn(SFc15_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void init_dsm_address_info(SFc15_leader_qball2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_leader_qball2 = 0U;
}
  ...
  (SFc15_leader_qball2InstanceStruct *chartInstance)
{
  ...
  c15_b_hoistedGlobal = chartInstance->c15_is_active_c15_leader_qball2;
  ...
  *chartInstance, const mxArray *c15_st)
{
  ...
  *c15_adj_pitch_cmd = c15_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c15_is_active_c15_leader_qball2 = c15_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 1)),
     "is_active_c15_leader_qball2");
  sf_mex_destroy(&c15_u);
  c15_update_debugger_state_c15_leader_qball2(chartInstance);
  ...
  *c15_inData)
{
  ...
  const mxArray *c15_y = NULL;
  SFc15_leader_qball2InstanceStruct *chartInstance;
  chartInstance = (SFc15_leader_qball2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c15_leader_qball2_get_eml_resolved_functions_info(void)
{
  ...
  *c15_identifier)
{
  ...
  c15_y = c15_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_leader_qball2), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_leader_qball2);
  return c15_y;
}
...
void sf_c15_leader_qball2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_leader_qball2_get_autoinheritance_info(void)
{
...
mxArray *sf_c15_leader_qball2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c15_leader_qball2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c15_leader_qball2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[6],T\"adj_pitch_cmd\",},{M[8],M[0],T\"is_active_c15_leader_qball2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_leader_qball2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc15_leader_qball2InstanceStruct *)
...
static void sf_opaque_initialize_c15_leader_qball2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc15_leader_qball2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c15_leader_qball2((SFc15_leader_qball2InstanceStruct*)
    chartInstanceVar);
  initialize_c15_leader_qball2((SFc15_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_leader_qball2(void *chartInstanceVar)
{
  enable_c15_leader_qball2((SFc15_leader_qball2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_leader_qball2(void *chartInstanceVar)
{
  disable_c15_leader_qball2((SFc15_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c15_leader_qball2(void *chartInstanceVar)
{
  sf_gateway_c15_leader_qball2((SFc15_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_leader_qball2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_leader_qball2
    ((SFc15_leader_qball2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_leader_qball2();/* state var info */
...
extern void sf_internal_set_sim_state_c15_leader_qball2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c15_leader_qball2();/* state var info */
  ...
  set_sim_state_c15_leader_qball2((SFc15_leader_qball2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_leader_qball2(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_leader_qball2(S);
}

static void sf_opaque_set_sim_state_c15_leader_qball2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c15_leader_qball2(S, st);
}

static void sf_opaque_terminate_c15_leader_qball2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_leader_qball2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c15_leader_qball2((SFc15_leader_qball2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_leader_qball2((SFc15_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_leader_qball2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c15_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c15_leader_qball2(SimStruct *S)
{
  SFc15_leader_qball2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc15_leader_qball2InstanceStruct *)utMalloc(sizeof
    (SFc15_leader_qball2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_leader_qball2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c15_leader_qball2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_leader_qball2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c15_leader_qball2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_leader_qball2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_leader_qball2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_leader_qball2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_leader_qball2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_leader_qball2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_leader_qball2;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_leader_qball2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_leader_qball2;
...
void c15_leader_qball2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_leader_qball2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_leader_qball2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_leader_qball2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_leader_qball2_method_dispatcher.\n"
