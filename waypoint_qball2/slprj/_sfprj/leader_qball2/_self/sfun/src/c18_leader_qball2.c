...
static void initialize_c18_leader_qball2(SFc18_leader_qball2InstanceStruct
  *chartInstance);
static void initialize_params_c18_leader_qball2
  (SFc18_leader_qball2InstanceStruct *chartInstance);
static void enable_c18_leader_qball2(SFc18_leader_qball2InstanceStruct
  *chartInstance);
static void disable_c18_leader_qball2(SFc18_leader_qball2InstanceStruct
  *chartInstance);
static void c18_update_debugger_state_c18_leader_qball2
  (SFc18_leader_qball2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_leader_qball2
  (SFc18_leader_qball2InstanceStruct *chartInstance);
static void set_sim_state_c18_leader_qball2(SFc18_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c18_st);
static void finalize_c18_leader_qball2(SFc18_leader_qball2InstanceStruct
  *chartInstance);
static void sf_gateway_c18_leader_qball2(SFc18_leader_qball2InstanceStruct
  *chartInstance);
static void initSimStructsc18_leader_qball2(SFc18_leader_qball2InstanceStruct
  *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c18_pitch_acc, const char_T *c18_identifier);
static real_T c18_b_emlrt_marshallIn(SFc18_leader_qball2InstanceStruct
...
static real_T c18_eml_xnrm2(SFc18_leader_qball2InstanceStruct *chartInstance,
  real_T c18_x[3]);
static real_T c18_atan2(SFc18_leader_qball2InstanceStruct *chartInstance, real_T
  c18_y, real_T c18_x);
static const mxArray *c18_c_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_c_emlrt_marshallIn(SFc18_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_d_emlrt_marshallIn(SFc18_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_leader_qball2, const char_T
  *c18_identifier);
static uint8_T c18_e_emlrt_marshallIn(SFc18_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_leader_qball2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_leader_qball2 = 0U;
}
  ...
  (SFc18_leader_qball2InstanceStruct *chartInstance)
{
  ...
  c18_c_hoistedGlobal = chartInstance->c18_is_active_c18_leader_qball2;
  ...
  *chartInstance, const mxArray *c18_st)
{
  ...
  *c18_roll_acc = c18_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c18_u, 1)), "roll_acc");
  chartInstance->c18_is_active_c18_leader_qball2 = c18_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 2)),
     "is_active_c18_leader_qball2");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_leader_qball2(chartInstance);
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_leader_qball2InstanceStruct *chartInstance;
  chartInstance = (SFc18_leader_qball2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c18_leader_qball2_get_eml_resolved_functions_info(void)
{
  ...
  *c18_identifier)
{
  ...
  c18_y = c18_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_leader_qball2), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_leader_qball2);
  return c18_y;
}
...
void sf_c18_leader_qball2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c18_leader_qball2_get_autoinheritance_info(void)
{
...
mxArray *sf_c18_leader_qball2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_leader_qball2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c18_leader_qball2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pitch_acc\",},{M[1],M[4],T\"roll_acc\",},{M[8],M[0],T\"is_active_c18_leader_qball2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_leader_qball2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc18_leader_qball2InstanceStruct *)
...
static void sf_opaque_initialize_c18_leader_qball2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_leader_qball2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_leader_qball2((SFc18_leader_qball2InstanceStruct*)
    chartInstanceVar);
  initialize_c18_leader_qball2((SFc18_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_leader_qball2(void *chartInstanceVar)
{
  enable_c18_leader_qball2((SFc18_leader_qball2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c18_leader_qball2(void *chartInstanceVar)
{
  disable_c18_leader_qball2((SFc18_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_leader_qball2(void *chartInstanceVar)
{
  sf_gateway_c18_leader_qball2((SFc18_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_leader_qball2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_leader_qball2
    ((SFc18_leader_qball2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_leader_qball2();/* state var info */
...
extern void sf_internal_set_sim_state_c18_leader_qball2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c18_leader_qball2();/* state var info */
  ...
  set_sim_state_c18_leader_qball2((SFc18_leader_qball2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_leader_qball2(SimStruct* S)
{
  return sf_internal_get_sim_state_c18_leader_qball2(S);
}

static void sf_opaque_set_sim_state_c18_leader_qball2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c18_leader_qball2(S, st);
}

static void sf_opaque_terminate_c18_leader_qball2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_leader_qball2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c18_leader_qball2((SFc18_leader_qball2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc18_leader_qball2((SFc18_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_leader_qball2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c18_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_leader_qball2(SimStruct *S)
{
  SFc18_leader_qball2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc18_leader_qball2InstanceStruct *)utMalloc(sizeof
    (SFc18_leader_qball2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_leader_qball2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_leader_qball2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_leader_qball2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_leader_qball2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c18_leader_qball2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c18_leader_qball2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_leader_qball2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_leader_qball2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_leader_qball2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_leader_qball2;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_leader_qball2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c18_leader_qball2;
...
void c18_leader_qball2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_leader_qball2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_leader_qball2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_leader_qball2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_leader_qball2_method_dispatcher.\n"
