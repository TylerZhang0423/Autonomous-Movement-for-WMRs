...
static void initialize_c21_leader_qball2(SFc21_leader_qball2InstanceStruct
  *chartInstance);
static void initialize_params_c21_leader_qball2
  (SFc21_leader_qball2InstanceStruct *chartInstance);
static void enable_c21_leader_qball2(SFc21_leader_qball2InstanceStruct
  *chartInstance);
static void disable_c21_leader_qball2(SFc21_leader_qball2InstanceStruct
  *chartInstance);
static void c21_update_debugger_state_c21_leader_qball2
  (SFc21_leader_qball2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c21_leader_qball2
  (SFc21_leader_qball2InstanceStruct *chartInstance);
static void set_sim_state_c21_leader_qball2(SFc21_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c21_st);
static void finalize_c21_leader_qball2(SFc21_leader_qball2InstanceStruct
  *chartInstance);
static void sf_gateway_c21_leader_qball2(SFc21_leader_qball2InstanceStruct
  *chartInstance);
static void initSimStructsc21_leader_qball2(SFc21_leader_qball2InstanceStruct
  *chartInstance);
...
static const mxArray *c21_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static real_T c21_emlrt_marshallIn(SFc21_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c21_y, const char_T *c21_identifier);
static real_T c21_b_emlrt_marshallIn(SFc21_leader_qball2InstanceStruct
...
static const mxArray *c21_b_sf_marshallOut(void *chartInstanceVoid, void
  *c21_inData);
static int32_T c21_c_emlrt_marshallIn(SFc21_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void c21_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c21_mxArrayInData, const char_T *c21_varName, void *c21_outData);
static uint8_T c21_d_emlrt_marshallIn(SFc21_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c21_b_is_active_c21_leader_qball2, const char_T
  *c21_identifier);
static uint8_T c21_e_emlrt_marshallIn(SFc21_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c21_u, const emlrtMsgIdentifier *c21_parentId);
static void init_dsm_address_info(SFc21_leader_qball2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c21_is_active_c21_leader_qball2 = 0U;
}
  ...
  (SFc21_leader_qball2InstanceStruct *chartInstance)
{
  ...
  c21_b_hoistedGlobal = chartInstance->c21_is_active_c21_leader_qball2;
  ...
  *chartInstance, const mxArray *c21_st)
{
  ...
  *c21_y = c21_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c21_u,
    0)), "y");
  chartInstance->c21_is_active_c21_leader_qball2 = c21_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c21_u, 1)),
     "is_active_c21_leader_qball2");
  sf_mex_destroy(&c21_u);
  c21_update_debugger_state_c21_leader_qball2(chartInstance);
  ...
  *c21_inData)
{
  ...
  const mxArray *c21_y = NULL;
  SFc21_leader_qball2InstanceStruct *chartInstance;
  chartInstance = (SFc21_leader_qball2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c21_leader_qball2_get_eml_resolved_functions_info(void)
{
  ...
  *c21_identifier)
{
  ...
  c21_y = c21_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c21_b_is_active_c21_leader_qball2), &c21_thisId);
  sf_mex_destroy(&c21_b_is_active_c21_leader_qball2);
  return c21_y;
}
...
void sf_c21_leader_qball2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c21_leader_qball2_get_autoinheritance_info(void)
{
...
mxArray *sf_c21_leader_qball2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c21_leader_qball2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c21_leader_qball2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c21_leader_qball2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c21_leader_qball2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc21_leader_qball2InstanceStruct *)
...
static void sf_opaque_initialize_c21_leader_qball2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc21_leader_qball2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c21_leader_qball2((SFc21_leader_qball2InstanceStruct*)
    chartInstanceVar);
  initialize_c21_leader_qball2((SFc21_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c21_leader_qball2(void *chartInstanceVar)
{
  enable_c21_leader_qball2((SFc21_leader_qball2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c21_leader_qball2(void *chartInstanceVar)
{
  disable_c21_leader_qball2((SFc21_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c21_leader_qball2(void *chartInstanceVar)
{
  sf_gateway_c21_leader_qball2((SFc21_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c21_leader_qball2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c21_leader_qball2
    ((SFc21_leader_qball2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c21_leader_qball2();/* state var info */
...
extern void sf_internal_set_sim_state_c21_leader_qball2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c21_leader_qball2();/* state var info */
  ...
  set_sim_state_c21_leader_qball2((SFc21_leader_qball2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c21_leader_qball2(SimStruct* S)
{
  return sf_internal_get_sim_state_c21_leader_qball2(S);
}

static void sf_opaque_set_sim_state_c21_leader_qball2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c21_leader_qball2(S, st);
}

static void sf_opaque_terminate_c21_leader_qball2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc21_leader_qball2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c21_leader_qball2((SFc21_leader_qball2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc21_leader_qball2((SFc21_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c21_leader_qball2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c21_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c21_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c21_leader_qball2(SimStruct *S)
{
  SFc21_leader_qball2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc21_leader_qball2InstanceStruct *)utMalloc(sizeof
    (SFc21_leader_qball2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc21_leader_qball2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c21_leader_qball2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c21_leader_qball2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c21_leader_qball2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c21_leader_qball2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c21_leader_qball2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c21_leader_qball2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c21_leader_qball2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c21_leader_qball2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c21_leader_qball2;
  chartInstance->chartInfo.mdlStart = mdlStart_c21_leader_qball2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c21_leader_qball2;
...
void c21_leader_qball2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c21_leader_qball2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c21_leader_qball2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c21_leader_qball2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c21_leader_qball2_method_dispatcher.\n"
