...
static void initialize_c4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance);
static void initialize_params_c4_leader_qball2(SFc4_leader_qball2InstanceStruct *
  chartInstance);
static void enable_c4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance);
static void disable_c4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_leader_qball2
  (SFc4_leader_qball2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_leader_qball2
  (SFc4_leader_qball2InstanceStruct *chartInstance);
static void set_sim_state_c4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_st);
static void finalize_c4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance);
static void sf_gateway_c4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance);
static void c4_chartstep_c4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance);
static void initSimStructsc4_leader_qball2(SFc4_leader_qball2InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_b_x_bias, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_c_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_b_x_angle, const char_T *c4_identifier);
static real_T c4_d_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_e_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_b_P_11, const char_T *c4_identifier);
static real_T c4_f_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_g_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_b_P_10, const char_T *c4_identifier);
static real_T c4_h_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_i_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_b_P_01, const char_T *c4_identifier);
static real_T c4_j_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_k_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_b_P_00, const char_T *c4_identifier);
static real_T c4_l_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_g_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static real_T c4_m_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_angle, const char_T *c4_identifier);
static real_T c4_n_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
...
static const mxArray *c4_h_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_o_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_p_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_leader_qball2, const char_T
  *c4_identifier);
static uint8_T c4_q_emlrt_marshallIn(SFc4_leader_qball2InstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_leader_qball2InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_leader_qball2 = 0U;
}
  ...
  (SFc4_leader_qball2InstanceStruct *chartInstance)
{
  ...
  c4_h_hoistedGlobal = chartInstance->c4_is_active_c4_leader_qball2;
  ...
  *chartInstance, const mxArray *c4_st)
{
  ...
  *c4_angle = c4_m_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c4_is_active_c4_leader_qball2 = c4_p_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 7)),
     "is_active_c4_leader_qball2");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_leader_qball2(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_leader_qball2(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_leader_qball2InstanceStruct *chartInstance;
  chartInstance = (SFc4_leader_qball2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_leader_qball2_get_eml_resolved_functions_info(void)
{
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_q_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_leader_qball2), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_leader_qball2);
  return c4_y;
}
...
void sf_c4_leader_qball2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_leader_qball2_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_leader_qball2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_leader_qball2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_leader_qball2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[4],T\"angle\",},{M[4],M[0],T\"P_00\",S'l','i','p'{{M1x2[273 277],M[0],}}},{M[4],M[0],T\"P_01\",S'l','i','p'{{M1x2[294 298],M[0],}}},{M[4],M[0],T\"P_10\",S'l','i','p'{{M1x2[315 319],M[0],}}},{M[4],M[0],T\"P_11\",S'l','i','p'{{M1x2[336 340],M[0],}}},{M[4],M[0],T\"x_angle\",S'l','i','p'{{M1x2[357 364],M[0],}}},{M[4],M[0],T\"x_bias\",S'l','i','p'{{M1x2[381 387],M[0],}}},{M[8],M[0],T\"is_active_c4_leader_qball2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_leader_qball2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_leader_qball2InstanceStruct *)
...
static void sf_opaque_initialize_c4_leader_qball2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_leader_qball2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_leader_qball2((SFc4_leader_qball2InstanceStruct*)
    chartInstanceVar);
  initialize_c4_leader_qball2((SFc4_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_leader_qball2(void *chartInstanceVar)
{
  enable_c4_leader_qball2((SFc4_leader_qball2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_leader_qball2(void *chartInstanceVar)
{
  disable_c4_leader_qball2((SFc4_leader_qball2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_leader_qball2(void *chartInstanceVar)
{
  sf_gateway_c4_leader_qball2((SFc4_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_leader_qball2(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_leader_qball2
    ((SFc4_leader_qball2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_leader_qball2();/* state var info */
...
extern void sf_internal_set_sim_state_c4_leader_qball2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_leader_qball2();/* state var info */
  ...
  set_sim_state_c4_leader_qball2((SFc4_leader_qball2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_leader_qball2(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_leader_qball2(S);
}

static void sf_opaque_set_sim_state_c4_leader_qball2(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c4_leader_qball2(S, st);
}

static void sf_opaque_terminate_c4_leader_qball2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_leader_qball2InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_leader_qball2((SFc4_leader_qball2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_leader_qball2((SFc4_leader_qball2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_leader_qball2(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_leader_qball2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_leader_qball2(SimStruct *S)
{
  SFc4_leader_qball2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_leader_qball2InstanceStruct *)utMalloc(sizeof
    (SFc4_leader_qball2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_leader_qball2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_leader_qball2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_leader_qball2;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_leader_qball2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_leader_qball2;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_leader_qball2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_leader_qball2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_leader_qball2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_leader_qball2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_leader_qball2;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_leader_qball2;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_leader_qball2;
...
void c4_leader_qball2_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_leader_qball2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_leader_qball2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_leader_qball2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_leader_qball2_method_dispatcher.\n"
