...
static const char * c18_debug_family_names[6] = { "n", "nargin", "nargout",
  "acc_body", "roll_acc", "pitch_acc" };

/* Function Declarations */
static void initialize_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static void initialize_params_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static void enable_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static void disable_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static void c18_update_debugger_state_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static void set_sim_state_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance, const mxArray
   *c18_st);
static void finalize_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static void sf_gateway_c18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
static void initSimStructsc18_leader_qball2_mytest
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance);
...
static const mxArray *c18_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static real_T c18_emlrt_marshallIn(SFc18_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c18_pitch_acc, const char_T *c18_identifier);
static real_T c18_b_emlrt_marshallIn(SFc18_leader_qball2_mytestInstanceStruct
...
static real_T c18_eml_xnrm2(SFc18_leader_qball2_mytestInstanceStruct
  *chartInstance, real_T c18_x[3]);
static real_T c18_atan2(SFc18_leader_qball2_mytestInstanceStruct *chartInstance,
  real_T c18_y, real_T c18_x);
static const mxArray *c18_c_sf_marshallOut(void *chartInstanceVoid, void
  *c18_inData);
static int32_T c18_c_emlrt_marshallIn(SFc18_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void c18_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData);
static uint8_T c18_d_emlrt_marshallIn(SFc18_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c18_b_is_active_c18_leader_qball2_mytest, const
  char_T *c18_identifier);
static uint8_T c18_e_emlrt_marshallIn(SFc18_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c18_u, const emlrtMsgIdentifier *c18_parentId);
static void init_dsm_address_info(SFc18_leader_qball2_mytestInstanceStruct
  *chartInstance);
  ...
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c18_is_active_c18_leader_qball2_mytest = 0U;
}
  ...
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance)
{
  ...
  real_T *c18_pitch_acc;
  real_T *c18_roll_acc;
  c18_pitch_acc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c18_roll_acc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c18_st = NULL;
  c18_st = NULL;
  c18_y = NULL;
  sf_mex_assign(&c18_y, sf_mex_createcellmatrix(3, 1), false);
  c18_hoistedGlobal = *c18_pitch_acc;
  c18_u = c18_hoistedGlobal;
  c18_b_y = NULL;
  sf_mex_assign(&c18_b_y, sf_mex_create("y", &c18_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c18_y, 0, c18_b_y);
  c18_b_hoistedGlobal = *c18_roll_acc;
  ...
  c18_c_hoistedGlobal = chartInstance->c18_is_active_c18_leader_qball2_mytest;
   ...
   *c18_st)
{
  ...
  *c18_pitch_acc = c18_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c18_u, 0)), "pitch_acc");
  *c18_roll_acc = c18_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c18_u, 1)), "roll_acc");
  chartInstance->c18_is_active_c18_leader_qball2_mytest = c18_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c18_u, 2)),
     "is_active_c18_leader_qball2_mytest");
  sf_mex_destroy(&c18_u);
  c18_update_debugger_state_c18_leader_qball2_mytest(chartInstance);
  ...
  (SFc18_leader_qball2_mytestInstanceStruct *chartInstance)
{
  ...
  int32_T c18_i4;
  int32_T c18_i5;
  static real_T c18_dv0[3] = { 0.0, 0.0, 1.0 };
  ...
  real_T c18_f_x;
  int32_T c18_i6;
  real_T *c18_b_pitch_acc;
  real_T *c18_b_roll_acc;
  real_T (*c18_b_acc_body)[3];
  c18_b_acc_body = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  c18_b_pitch_acc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c18_b_roll_acc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c18_i0 = 0; c18_i0 < 3; c18_i0++) {
    c18_acc_body[c18_i0] = (*c18_b_acc_body)[c18_i0];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c18_debug_family_names,
    c18_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_n, 0U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_nargout, 2U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c18_acc_body, 3U, c18_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_roll_acc, 4U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c18_pitch_acc, 5U, c18_sf_marshallOut,
    c18_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 3);
  for (c18_i1 = 0; c18_i1 < 3; c18_i1++) {
    c18_x[c18_i1] = c18_acc_body[c18_i1];
  }

  for (c18_i2 = 0; c18_i2 < 3; c18_i2++) {
    c18_b_x[c18_i2] = c18_x[c18_i2];
  }

  c18_n = c18_eml_xnrm2(chartInstance, c18_b_x);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 4);
  if (CV_EML_IF(0, 1, 0, c18_n > 2.2204460492503131E-16)) {
    _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 5);
    for (c18_i3 = 0; c18_i3 < 3; c18_i3++) {
      c18_x[c18_i3] = -c18_acc_body[c18_i3];
    }
    ...
    for (c18_i4 = 0; c18_i4 < 3; c18_i4++) {
      c18_acc_body[c18_i4] = c18_x[c18_i4] / c18_c_y;
    }
  } else {
    _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 7);
    for (c18_i5 = 0; c18_i5 < 3; c18_i5++) {
      c18_acc_body[c18_i5] = c18_dv0[c18_i5];
    }
  }

  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 10);
  c18_roll_acc = c18_atan2(chartInstance, c18_acc_body[1], c18_acc_body[2]);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, 11);
  c18_c_x = c18_roll_acc;
  c18_d_x = c18_c_x;
  c18_d_x = muDoubleScalarSin(c18_d_x);
  c18_e_x = c18_roll_acc;
  c18_f_x = c18_e_x;
  c18_f_x = muDoubleScalarCos(c18_f_x);
  c18_pitch_acc = c18_atan2(chartInstance, -c18_acc_body[0], c18_acc_body[1] *
    c18_d_x + c18_acc_body[2] * c18_f_x);
  _SFD_EML_CALL(0U, chartInstance->c18_sfEvent, -11);
  _SFD_SYMBOL_SCOPE_POP();
  *c18_b_roll_acc = c18_roll_acc;
  *c18_b_pitch_acc = c18_pitch_acc;
  ...
  _SFD_DATA_RANGE_CHECK(*c18_b_roll_acc, 0U);
  _SFD_DATA_RANGE_CHECK(*c18_b_pitch_acc, 1U);
  for (c18_i6 = 0; c18_i6 < 3; c18_i6++) {
    _SFD_DATA_RANGE_CHECK((*c18_b_acc_body)[c18_i6], 2U);
  }
}
  ...
  *c18_inData)
{
  ...
  const mxArray *c18_y = NULL;
  SFc18_leader_qball2_mytestInstanceStruct *chartInstance;
  chartInstance = (SFc18_leader_qball2_mytestInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c18_pitch_acc, const char_T *c18_identifier)
{
  ...
  c18_y = c18_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c18_pitch_acc),
    &c18_thisId);
  sf_mex_destroy(&c18_pitch_acc);
  return c18_y;
}
...
static void c18_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c18_mxArrayInData, const char_T *c18_varName, void *c18_outData)
{
  const mxArray *c18_pitch_acc;
  const char_T *c18_identifier;
  emlrtMsgIdentifier c18_thisId;
  real_T c18_y;
  SFc18_leader_qball2_mytestInstanceStruct *chartInstance;
  chartInstance = (SFc18_leader_qball2_mytestInstanceStruct *)chartInstanceVoid;
  c18_pitch_acc = sf_mex_dup(c18_mxArrayInData);
...
const mxArray *sf_c18_leader_qball2_mytest_get_eml_resolved_functions_info(void)
{
  const mxArray *c18_nameCaptureInfo = NULL;
  c18_nameCaptureInfo = NULL;
  sf_mex_assign(&c18_nameCaptureInfo, sf_mex_createstruct("structure", 2, 43, 1),
                false);
...
static void c18_info_helper(const mxArray **c18_info)
{
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("norm"), "name", "name", 0);
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1363731868U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/isBuiltInNumeric.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1363732556U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m!genpnorm"),
                  "context", "context", 4);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("eml_xnrm2"), "name", "name",
                  4);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xnrm2.m"),
                  "resolved", "resolved", 4);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1376002292U), "fileTimeLo",
                  "fileTimeLo", 4);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 4);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+blas/inline.p"),
                  "resolved", "resolved", 5);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1389329522U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xnrm2.m"), "context",
                  "context", 6);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("coder.internal.blas.xnrm2"),
                  "name", "name", 6);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 6);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_switch_helper.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1381871900U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 11);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("realmin"), "name", "name",
                  11);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 11);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "resolved",
                  "resolved", 11);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1307672842U), "fileTimeLo",
                  "fileTimeLo", 11);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 11);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m"), "context",
                  "context", 12);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("eml_realmin"), "name",
                  "name", 12);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_realmin.m"), "resolved",
                  "resolved", 12);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1307672844U), "fileTimeLo",
                  "fileTimeLo", 12);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 12);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1326749596U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1372604760U), "fileTimeLo",
                  "fileTimeLo", 14);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 14);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 18);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1362283482U), "fileTimeLo",
                  "fileTimeLo", 18);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 18);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/+refblas/xnrm2.p"),
                  "context", "context", 20);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("abs"), "name", "name", 20);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("eps"), "name", "name", 23);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 24);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("eml_eps"), "name", "name",
                  24);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, sf_mex_duplicatearraysafe(&c18_lhs25), "lhs", "lhs",
                  25);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(""), "context", "context", 26);
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 26);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1388481696U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[IXE]$matlabroot$/toolbox/coder/coder/+coder/+internal/div.p"), "resolved",
                  "resolved", 32);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1389329520U), "fileTimeLo",
                  "fileTimeLo", 32);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 32);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, sf_mex_duplicatearraysafe(&c18_lhs32), "lhs", "lhs",
                  32);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(""), "context", "context", 33);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("atan2"), "name", "name", 33);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m"), "resolved",
                  "resolved", 33);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1343851972U), "fileTimeLo",
                  "fileTimeLo", 33);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 33);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m"), "context",
                  "context", 38);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("eml_scalar_atan2"), "name",
                  "name", 38);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 38);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1286840320U), "fileTimeLo",
                  "fileTimeLo", 38);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 38);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, sf_mex_duplicatearraysafe(&c18_lhs38), "lhs", "lhs",
                  38);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(""), "context", "context", 39);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("sin"), "name", "name", 39);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 39);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m"), "resolved",
                  "resolved", 39);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1343851986U), "fileTimeLo",
                  "fileTimeLo", 39);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 39);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1286840336U), "fileTimeLo",
                  "fileTimeLo", 40);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 40);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c18_info, sf_mex_duplicatearraysafe(&c18_lhs40), "lhs", "lhs",
                  40);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(""), "context", "context", 41);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("cos"), "name", "name", 41);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 41);
  sf_mex_addfield(*c18_info, c18_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(1286840322U), "fileTimeLo",
                  "fileTimeLo", 42);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 42);
  sf_mex_addfield(*c18_info, c18_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  *chartInstance, real_T c18_x[3])
{
  ...
  return c18_scale * muDoubleScalarSqrt(c18_y);
}
  ...
  real_T c18_y, real_T c18_x)
{
  ...
  c18_b_y = c18_y;
  c18_b_x = c18_x;
  return muDoubleScalarAtan2(c18_b_y, c18_b_x);
}
  ...
  char_T *c18_identifier)
{
  ...
  c18_y = c18_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c18_b_is_active_c18_leader_qball2_mytest), &c18_thisId);
  sf_mex_destroy(&c18_b_is_active_c18_leader_qball2_mytest);
  return c18_y;
}
...
void sf_c18_leader_qball2_mytest_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3443842469U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2670914330U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4190184924U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(361327952U);
}

mxArray *sf_c18_leader_qball2_mytest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("brlIAlTsodQFE1dr5xSjNC");
...
mxArray *sf_c18_leader_qball2_mytest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c18_leader_qball2_mytest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c18_leader_qball2_mytest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pitch_acc\",},{M[1],M[4],T\"roll_acc\",},{M[8],M[0],T\"is_active_c18_leader_qball2_mytest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c18_leader_qball2_mytest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc18_leader_qball2_mytestInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,77,85,115,148);
...

        {
          ...
          real_T *c18_pitch_acc;
          real_T (*c18_acc_body)[3];
          c18_acc_body = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
          c18_pitch_acc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
          c18_roll_acc = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          _SFD_SET_DATA_VALUE_PTR(0U, c18_roll_acc);
          _SFD_SET_DATA_VALUE_PTR(1U, c18_pitch_acc);
          _SFD_SET_DATA_VALUE_PTR(2U, *c18_acc_body);
        }
      }
    } else {
...
{
  return "oYVXTMUV1b7TsKljD1qm6F";
}

static void sf_opaque_initialize_c18_leader_qball2_mytest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc18_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c18_leader_qball2_mytest
    ((SFc18_leader_qball2_mytestInstanceStruct*) chartInstanceVar);
  initialize_c18_leader_qball2_mytest((SFc18_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c18_leader_qball2_mytest(void *chartInstanceVar)
{
  enable_c18_leader_qball2_mytest((SFc18_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c18_leader_qball2_mytest(void *chartInstanceVar)
{
  disable_c18_leader_qball2_mytest((SFc18_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c18_leader_qball2_mytest(void *chartInstanceVar)
{
  sf_gateway_c18_leader_qball2_mytest((SFc18_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c18_leader_qball2_mytest
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c18_leader_qball2_mytest
    ((SFc18_leader_qball2_mytestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c18_leader_qball2_mytest();/* state var info */
...
extern void sf_internal_set_sim_state_c18_leader_qball2_mytest(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c18_leader_qball2_mytest();/* state var info */
  ...
  set_sim_state_c18_leader_qball2_mytest
    ((SFc18_leader_qball2_mytestInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c18_leader_qball2_mytest(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c18_leader_qball2_mytest(S);
}

static void sf_opaque_set_sim_state_c18_leader_qball2_mytest(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c18_leader_qball2_mytest(S, st);
}

static void sf_opaque_terminate_c18_leader_qball2_mytest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc18_leader_qball2_mytestInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c18_leader_qball2_mytest((SFc18_leader_qball2_mytestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc18_leader_qball2_mytest
    ((SFc18_leader_qball2_mytestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c18_leader_qball2_mytest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c18_leader_qball2_mytest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4034096046U));
  ssSetChecksum1(S,(1287687551U));
  ssSetChecksum2(S,(3755492631U));
  ssSetChecksum3(S,(2945070425U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c18_leader_qball2_mytest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c18_leader_qball2_mytest(SimStruct *S)
{
  SFc18_leader_qball2_mytestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc18_leader_qball2_mytestInstanceStruct *)utMalloc(sizeof
    (SFc18_leader_qball2_mytestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc18_leader_qball2_mytestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c18_leader_qball2_mytest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c18_leader_qball2_mytest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c18_leader_qball2_mytest;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c18_leader_qball2_mytest;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c18_leader_qball2_mytest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c18_leader_qball2_mytest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c18_leader_qball2_mytest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c18_leader_qball2_mytest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c18_leader_qball2_mytest;
  chartInstance->chartInfo.mdlStart = mdlStart_c18_leader_qball2_mytest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c18_leader_qball2_mytest;
...
void c18_leader_qball2_mytest_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c18_leader_qball2_mytest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c18_leader_qball2_mytest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c18_leader_qball2_mytest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c18_leader_qball2_mytest_method_dispatcher.\n"
