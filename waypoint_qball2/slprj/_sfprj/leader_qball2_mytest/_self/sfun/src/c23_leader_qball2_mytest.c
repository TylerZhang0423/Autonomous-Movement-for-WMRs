...
static void initialize_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static void initialize_params_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static void enable_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static void disable_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static void c23_update_debugger_state_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static void set_sim_state_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance, const mxArray
   *c23_st);
static void finalize_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static void sf_gateway_c23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
static void initSimStructsc23_leader_qball2_mytest
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance);
...
static const mxArray *c23_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static real_T c23_emlrt_marshallIn(SFc23_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c23_pitch_acc, const char_T *c23_identifier);
static real_T c23_b_emlrt_marshallIn(SFc23_leader_qball2_mytestInstanceStruct
...
static void c23_eml_error(SFc23_leader_qball2_mytestInstanceStruct
  *chartInstance);
static const mxArray *c23_c_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static int32_T c23_c_emlrt_marshallIn(SFc23_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void c23_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c23_mxArrayInData, const char_T *c23_varName, void *c23_outData);
static uint8_T c23_d_emlrt_marshallIn(SFc23_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c23_b_is_active_c23_leader_qball2_mytest, const
  char_T *c23_identifier);
static uint8_T c23_e_emlrt_marshallIn(SFc23_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void init_dsm_address_info(SFc23_leader_qball2_mytestInstanceStruct
  *chartInstance);
  ...
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c23_is_active_c23_leader_qball2_mytest = 0U;
}
  ...
  (SFc23_leader_qball2_mytestInstanceStruct *chartInstance)
{
  ...
  c23_c_hoistedGlobal = chartInstance->c23_is_active_c23_leader_qball2_mytest;
   ...
   *c23_st)
{
  ...
  *c23_roll_acc = c23_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c23_u, 1)), "roll_acc");
  chartInstance->c23_is_active_c23_leader_qball2_mytest = c23_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c23_u, 2)),
     "is_active_c23_leader_qball2_mytest");
  sf_mex_destroy(&c23_u);
  c23_update_debugger_state_c23_leader_qball2_mytest(chartInstance);
  ...
  *c23_inData)
{
  ...
  const mxArray *c23_y = NULL;
  SFc23_leader_qball2_mytestInstanceStruct *chartInstance;
  chartInstance = (SFc23_leader_qball2_mytestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c23_leader_qball2_mytest_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c23_identifier)
{
  ...
  c23_y = c23_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c23_b_is_active_c23_leader_qball2_mytest), &c23_thisId);
  sf_mex_destroy(&c23_b_is_active_c23_leader_qball2_mytest);
  return c23_y;
}
...
void sf_c23_leader_qball2_mytest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c23_leader_qball2_mytest_get_autoinheritance_info(void)
{
...
mxArray *sf_c23_leader_qball2_mytest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c23_leader_qball2_mytest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c23_leader_qball2_mytest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"pitch_acc\",},{M[1],M[4],T\"roll_acc\",},{M[8],M[0],T\"is_active_c23_leader_qball2_mytest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c23_leader_qball2_mytest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc23_leader_qball2_mytestInstanceStruct *)
...
static void sf_opaque_initialize_c23_leader_qball2_mytest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc23_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c23_leader_qball2_mytest
    ((SFc23_leader_qball2_mytestInstanceStruct*) chartInstanceVar);
  initialize_c23_leader_qball2_mytest((SFc23_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c23_leader_qball2_mytest(void *chartInstanceVar)
{
  enable_c23_leader_qball2_mytest((SFc23_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c23_leader_qball2_mytest(void *chartInstanceVar)
{
  disable_c23_leader_qball2_mytest((SFc23_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c23_leader_qball2_mytest(void *chartInstanceVar)
{
  sf_gateway_c23_leader_qball2_mytest((SFc23_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c23_leader_qball2_mytest
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c23_leader_qball2_mytest
    ((SFc23_leader_qball2_mytestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c23_leader_qball2_mytest();/* state var info */
...
extern void sf_internal_set_sim_state_c23_leader_qball2_mytest(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c23_leader_qball2_mytest();/* state var info */
  ...
  set_sim_state_c23_leader_qball2_mytest
    ((SFc23_leader_qball2_mytestInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c23_leader_qball2_mytest(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c23_leader_qball2_mytest(S);
}

static void sf_opaque_set_sim_state_c23_leader_qball2_mytest(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c23_leader_qball2_mytest(S, st);
}

static void sf_opaque_terminate_c23_leader_qball2_mytest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc23_leader_qball2_mytestInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c23_leader_qball2_mytest((SFc23_leader_qball2_mytestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc23_leader_qball2_mytest
    ((SFc23_leader_qball2_mytestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c23_leader_qball2_mytest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c23_leader_qball2_mytest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c23_leader_qball2_mytest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c23_leader_qball2_mytest(SimStruct *S)
{
  SFc23_leader_qball2_mytestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc23_leader_qball2_mytestInstanceStruct *)utMalloc(sizeof
    (SFc23_leader_qball2_mytestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc23_leader_qball2_mytestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c23_leader_qball2_mytest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c23_leader_qball2_mytest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c23_leader_qball2_mytest;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c23_leader_qball2_mytest;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c23_leader_qball2_mytest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c23_leader_qball2_mytest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c23_leader_qball2_mytest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c23_leader_qball2_mytest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c23_leader_qball2_mytest;
  chartInstance->chartInfo.mdlStart = mdlStart_c23_leader_qball2_mytest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c23_leader_qball2_mytest;
...
void c23_leader_qball2_mytest_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_leader_qball2_mytest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_leader_qball2_mytest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_leader_qball2_mytest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_leader_qball2_mytest_method_dispatcher.\n"
