...
static void initialize_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void initialize_params_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void enable_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void disable_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void c6_update_debugger_state_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void set_sim_state_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance, const mxArray *c6_st);
static void finalize_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void sf_gateway_c6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void initSimStructsc6_leader_qball2_mytest
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c6_machineNumber, uint32_T
  c6_chartNumber, uint32_T c6_instanceNumber);
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData);
static real_T c6_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_b_counter, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_b_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_c_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_b_state, const char_T *c6_identifier);
static real_T c6_d_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static const mxArray *c6_c_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static real_T c6_e_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_enable, const char_T *c6_identifier);
static real_T c6_f_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
...
static const mxArray *c6_d_sf_marshallOut(void *chartInstanceVoid, void
  *c6_inData);
static int32_T c6_g_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void c6_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData);
static uint8_T c6_h_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_b_is_active_c6_leader_qball2_mytest, const
  char_T *c6_identifier);
static uint8_T c6_i_emlrt_marshallIn(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance, const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static void init_dsm_address_info(SFc6_leader_qball2_mytestInstanceStruct
  *chartInstance);
  ...
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_leader_qball2_mytest = 0U;
}
  ...
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance)
{
  ...
  c6_d_hoistedGlobal = chartInstance->c6_is_active_c6_leader_qball2_mytest;
  ...
  (SFc6_leader_qball2_mytestInstanceStruct *chartInstance, const mxArray *c6_st)
{
  ...
  *c6_enable = c6_e_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c6_is_active_c6_leader_qball2_mytest = c6_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 3)),
     "is_active_c6_leader_qball2_mytest");
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_leader_qball2_mytest(chartInstance);
...
static const mxArray *c6_sf_marshallOut(void *chartInstanceVoid, void *c6_inData)
{
  ...
  const mxArray *c6_y = NULL;
  SFc6_leader_qball2_mytestInstanceStruct *chartInstance;
  chartInstance = (SFc6_leader_qball2_mytestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c6_leader_qball2_mytest_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c6_identifier)
{
  ...
  c6_y = c6_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_leader_qball2_mytest), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_leader_qball2_mytest);
  return c6_y;
}
...
void sf_c6_leader_qball2_mytest_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c6_leader_qball2_mytest_get_autoinheritance_info(void)
{
...
mxArray *sf_c6_leader_qball2_mytest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_leader_qball2_mytest_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c6_leader_qball2_mytest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"enable\",},{M[4],M[0],T\"counter\",S'l','i','p'{{M1x2[87 94],M[0],}}},{M[4],M[0],T\"state\",S'l','i','p'{{M1x2[69 74],M[0],}}},{M[8],M[0],T\"is_active_c6_leader_qball2_mytest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_leader_qball2_mytest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc6_leader_qball2_mytestInstanceStruct *)
...
static void sf_opaque_initialize_c6_leader_qball2_mytest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc6_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c6_leader_qball2_mytest
    ((SFc6_leader_qball2_mytestInstanceStruct*) chartInstanceVar);
  initialize_c6_leader_qball2_mytest((SFc6_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c6_leader_qball2_mytest(void *chartInstanceVar)
{
  enable_c6_leader_qball2_mytest((SFc6_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c6_leader_qball2_mytest(void *chartInstanceVar)
{
  disable_c6_leader_qball2_mytest((SFc6_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c6_leader_qball2_mytest(void *chartInstanceVar)
{
  sf_gateway_c6_leader_qball2_mytest((SFc6_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c6_leader_qball2_mytest
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c6_leader_qball2_mytest
    ((SFc6_leader_qball2_mytestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c6_leader_qball2_mytest();/* state var info */
...
extern void sf_internal_set_sim_state_c6_leader_qball2_mytest(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c6_leader_qball2_mytest();/* state var info */
  ...
  set_sim_state_c6_leader_qball2_mytest((SFc6_leader_qball2_mytestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c6_leader_qball2_mytest(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c6_leader_qball2_mytest(S);
}

static void sf_opaque_set_sim_state_c6_leader_qball2_mytest(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c6_leader_qball2_mytest(S, st);
}

static void sf_opaque_terminate_c6_leader_qball2_mytest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_leader_qball2_mytestInstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_leader_qball2_mytest((SFc6_leader_qball2_mytestInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc6_leader_qball2_mytest((SFc6_leader_qball2_mytestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_leader_qball2_mytest(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c6_leader_qball2_mytest
      ((SFc6_leader_qball2_mytestInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c6_leader_qball2_mytest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c6_leader_qball2_mytest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c6_leader_qball2_mytest(SimStruct *S)
{
  SFc6_leader_qball2_mytestInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_leader_qball2_mytestInstanceStruct *)utMalloc(sizeof
    (SFc6_leader_qball2_mytestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc6_leader_qball2_mytestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_leader_qball2_mytest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_leader_qball2_mytest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_leader_qball2_mytest;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_leader_qball2_mytest;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_leader_qball2_mytest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_leader_qball2_mytest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_leader_qball2_mytest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_leader_qball2_mytest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_leader_qball2_mytest;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_leader_qball2_mytest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_leader_qball2_mytest;
...
void c6_leader_qball2_mytest_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_leader_qball2_mytest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_leader_qball2_mytest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_leader_qball2_mytest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_leader_qball2_mytest_method_dispatcher.\n"
