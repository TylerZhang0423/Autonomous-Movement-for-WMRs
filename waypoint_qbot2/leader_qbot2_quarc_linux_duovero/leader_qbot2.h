...
typedef struct {
  ...
  real_T x0_l;                         /* '<S21>/x0' */
  real_T RateLimiterTurningRate;       /* '<S3>/Rate Limiter - Turning Rate' */
...
typedef struct {
  ...
  real_T PrevY_m;                      /* '<S3>/Rate Limiter - Turning Rate' */
  real_T LastMajorTime_l;              /* '<S3>/Rate Limiter - Turning Rate' */
...
struct P_leader_qbot2_T_ {
  ...
  real_T x0_Value_n;                   /* Expression: input_init
                                        ...
                                        */
  real_T RateLimiterTurningRate_RisingLi;/* Expression: 1
                                          * Referenced by: '<S3>/Rate Limiter - Turning Rate'
                                          */
  real_T RateLimiterTurningRate_FallingL;/* Expression: -1
                                          * Referenced by: '<S3>/Rate Limiter - Turning Rate'
                                          */
