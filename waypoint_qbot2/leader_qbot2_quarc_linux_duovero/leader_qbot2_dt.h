...
static DataTypeTransition rtBTransitions[] = {
  ...
  { (char_T *)(&leader_qbot2_B.StreamClient_o2), 6, 0, 2 },

  { (char_T *)(&leader_qbot2_B.StreamServer_o1), 3, 0, 1 },

  { (char_T *)(&leader_qbot2_B.StreamClient_o4), 8, 0, 5 }
  ,

  { (char_T *)(&leader_qbot2_DW.DiscreteTimeIntegrator_DSTATE), 0, 0, 55 },

  { (char_T *)(&leader_qbot2_DW.StreamClient_Stream), 14, 0, 2 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&leader_qbot2_P.unity_Value), 0, 0, 44 },

  { (char_T *)(&leader_qbot2_P.StreamClient_SndPriority), 6, 0, 4 },

  { (char_T *)(&leader_qbot2_P.StreamClient_SndSize), 7, 0, 8 },

  { (char_T *)(&leader_qbot2_P.StreamClient_Optimize), 2, 0, 4 },

  { (char_T *)(&leader_qbot2_P.StringConstant1_Value[0]), 3, 0, 109 },

  { (char_T *)(&leader_qbot2_P.StreamClient_Active), 8, 0, 4 }
};
