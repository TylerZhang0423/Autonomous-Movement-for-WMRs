...
typedef RT_MODEL_mission_server_track_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * mission_server_tracking_qbot2(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void mission_server_tracking_qbot2_initialize();
   extern void mission_server_tracking_qbot2_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(mission_server_tracking_qbot_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  mission_server_tracking_qbot2_step();
  ...
  control_c_handler(int signal_number)
{
  ...
  {
    pstream_shutdown(mission_server_tracking_qbot_DW.StreamServer_Stream);
  }
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://mission_server_tracking_qbot2:1?timeout=10");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: mission_server_tracking_qbot2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  mission_server_tracking_qbot2_initialize();
  S = mission_server_tracking_qbot2_M;
  ...
  mission_server_tracking_qbot2_terminate();
