...
static void initialize_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void initialize_params_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void enable_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void disable_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void set_sim_state_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void sf_gateway_c2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void initSimStructsc2_mission_server_tracking_qbot2
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance, const
   mxArray *c2_b_idx, const char_T *c2_identifier);
...
static real_T c2_c_emlrt_marshallIn
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance, const
   mxArray *c2_mission_complete, const char_T *c2_identifier);
...
static real_T c2_eml_xnrm2(SFc2_mission_server_tracking_qbot2InstanceStruct
...
static uint8_T c2_f_emlrt_marshallIn
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_mission_server_tracking_qbot2, const char_T
   *c2_identifier);
  ...
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_mission_server_tracking_qbot2 = 0U;
}
  ...
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance)
{
  ...
  c2_f_hoistedGlobal =
    chartInstance->c2_is_active_c2_mission_server_tracking_qbot2;
   ...
   mxArray *c2_st)
{
  ...
  *c2_z_ref = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_mission_server_tracking_qbot2 =
    ...
    "is_active_c2_mission_server_tracking_qbot2");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_mission_server_tracking_qbot2(chartInstance);
  ...
  (SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance)
{
  ...
  real_T c2_b_hoistedGlobal;
  int32_T c2_i1;
  real_T c2_x_waypoint[3];
  int32_T c2_i2;
  real_T c2_z_waypoint[3];
  real_T c2_x_ugv;
  real_T c2_z_ugv;
  ...
  real_T (*c2_b_z_waypoint)[3];
  real_T (*c2_b_x_waypoint)[3];
  ...
  c2_b_z_waypoint = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c2_b_x_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c2_b_x_waypoint = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  c2_x[0] = c2_x_ugv - c2_x_waypoint[_SFD_EML_ARRAY_BOUNDS_CHECK("x_waypoint",
    (int32_T)_SFD_INTEGER_CHECK("idx", c2_c_hoistedGlobal), 1, 3, 1, 0) - 1];
  c2_x[1] = c2_z_ugv - c2_z_waypoint[_SFD_EML_ARRAY_BOUNDS_CHECK("z_waypoint",
    (int32_T)_SFD_INTEGER_CHECK("idx", c2_d_hoistedGlobal), 1, 3, 1, 0) - 1];
  ...
  if (CV_EML_COND(0, 1, 0, c2_dist > c2_DIST_THRESHOLD)) {
    guard1 = true;
  } else if (CV_EML_COND(0, 1, 1, chartInstance->c2_idx == 3.0)) {
    guard1 = true;
  } else {
    ...
    c2_x_ref = c2_x_waypoint[_SFD_EML_ARRAY_BOUNDS_CHECK("x_waypoint", (int32_T)
      _SFD_INTEGER_CHECK("idx", chartInstance->c2_idx), 1, 3, 1, 0) - 1];
  ...
  if (CV_EML_IF(0, 1, 2, chartInstance->c2_idx == 3.0)) {
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance;
  chartInstance = (SFc2_mission_server_tracking_qbot2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_mission_server_tracking_qbot2_get_eml_resolved_functions_info(void)
{
   ...
   *c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_mission_server_tracking_qbot2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_mission_server_tracking_qbot2);
  return c2_y;
}
...
void sf_c2_mission_server_tracking_qbot2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2693890935U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3663056572U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3751829621U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4190186052U);
}

mxArray *sf_c2_mission_server_tracking_qbot2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("w2RVDZJe35kBaJ2cqWzeNC");
...
mxArray *sf_c2_mission_server_tracking_qbot2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_mission_server_tracking_qbot2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_mission_server_tracking_qbot2
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[14],T\"mission_complete\",},{M[1],M[13],T\"waypoint_num\",},{M[1],M[5],T\"x_ref\",},{M[1],M[11],T\"z_ref\",},{M[4],M[0],T\"idx\",S'l','i','p'{{M1x2[370 373],M[0],}}},{M[8],M[0],T\"is_active_c2_mission_server_tracking_qbot2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_mission_server_tracking_qbot2_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c2_z_waypoint = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S,
            1);
          c2_x_ref = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c2_x_waypoint = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S,
            0);
...
{
  return "ZGVq0g9LKqmxl2Zn5Zf73G";
}

static void sf_opaque_initialize_c2_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_mission_server_tracking_qbot2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
  initialize_c2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  enable_c2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  disable_c2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  sf_gateway_c2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_mission_server_tracking_qbot2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_mission_server_tracking_qbot2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_mission_server_tracking_qbot2(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_mission_server_tracking_qbot2();/* state var info */
  ...
  set_sim_state_c2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_mission_server_tracking_qbot2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_mission_server_tracking_qbot2(S);
}

static void sf_opaque_set_sim_state_c2_mission_server_tracking_qbot2(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_mission_server_tracking_qbot2(S, st);
}

static void sf_opaque_terminate_c2_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_mission_server_tracking_qbot2InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_mission_server_tracking_qbot2
      ((SFc2_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_mission_server_tracking_qbot2
    ((SFc2_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_mission_server_tracking_qbot2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c2_mission_server_tracking_qbot2
      ((SFc2_mission_server_tracking_qbot2InstanceStruct*)
       (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_mission_server_tracking_qbot2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1037201983U));
  ssSetChecksum1(S,(2253697262U));
  ssSetChecksum2(S,(2509942311U));
  ssSetChecksum3(S,(2129234871U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_mission_server_tracking_qbot2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_mission_server_tracking_qbot2(SimStruct *S)
{
  SFc2_mission_server_tracking_qbot2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_mission_server_tracking_qbot2InstanceStruct *)utMalloc
    (sizeof(SFc2_mission_server_tracking_qbot2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_mission_server_tracking_qbot2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_mission_server_tracking_qbot2;
...
void c2_mission_server_tracking_qbot2_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_mission_server_tracking_qbot2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_mission_server_tracking_qbot2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_mission_server_tracking_qbot2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_mission_server_tracking_qbot2_method_dispatcher.\n"
