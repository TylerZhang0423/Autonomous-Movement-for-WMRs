...
static void initialize_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void initialize_params_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void enable_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void disable_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void ext_mode_exec_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void set_sim_state_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance, const
   mxArray *c4_st);
static void c4_set_sim_state_side_effects_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void finalize_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void sf_gateway_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
static void initSimStructsc4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance);
...
static uint8_T c4_e_emlrt_marshallIn
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance, const
   mxArray *c4_is_active_c4_mission_server_tracking_qbot2, const char_T
   *c4_identifier);
...
static void c4_updateDataWrittenToVector
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance, uint32_T
   c4_vectorIndex);
...
{
  int32_T *c4_sfEvent;
  uint8_T *c4_is_active_c4_mission_server_tracking_qbot2;
  uint8_T *c4_is_c4_mission_server_tracking_qbot2;
  c4_is_c4_mission_server_tracking_qbot2 = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c4_is_active_c4_mission_server_tracking_qbot2 = (uint8_T *)ssGetDWork
    (chartInstance->S, 2);
  ...
  *c4_is_active_c4_mission_server_tracking_qbot2 = 0U;
  *c4_is_c4_mission_server_tracking_qbot2 = c4_IN_NO_ACTIVE_CHILD;
}
  ...
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance)
{
  ...
  if (*c4_is_active_c4_mission_server_tracking_qbot2 == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 1U, *c4_sfEvent);
  }

  if (*c4_is_c4_mission_server_tracking_qbot2 == c4_IN_WaitForStartCommand) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *c4_sfEvent);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *c4_sfEvent);
  }

  if (*c4_is_c4_mission_server_tracking_qbot2 == c4_IN_QbotGetsWaypoints) {
...
static void ext_mode_exec_c4_mission_server_tracking_qbot2
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance)
{
  c4_update_debugger_state_c4_mission_server_tracking_qbot2(chartInstance);
}
  ...
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance)
{
  ...
  c4_c_hoistedGlobal = *c4_is_active_c4_mission_server_tracking_qbot2;
  c4_c_u = c4_c_hoistedGlobal;
  c4_d_y = NULL;
  sf_mex_assign(&c4_d_y, sf_mex_create("y", &c4_c_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c4_y, 2, c4_d_y);
  c4_d_hoistedGlobal = *c4_is_c4_mission_server_tracking_qbot2;
   ...
   mxArray *c4_st)
{
  ...
  *c4_z_ugv_ref = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c4_u, 1)), "z_ugv_ref");
  *c4_is_active_c4_mission_server_tracking_qbot2 = c4_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 2)),
     "is_active_c4_mission_server_tracking_qbot2");
  *c4_is_c4_mission_server_tracking_qbot2 = c4_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 3)), "is_c4_mission_server_tracking_qbot2");
  ...
  (SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance)
{
  ...
  c4_is_active_c4_mission_server_tracking_qbot2 = (uint8_T *)ssGetDWork
    (chartInstance->S, 2);
  c4_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  c4_set_sim_state_side_effects_c4_mission_server_tracking_qbot2(chartInstance);
  ...
  *c4_start_stop_start = *c4_start_stop;
  ...
  if (*c4_is_active_c4_mission_server_tracking_qbot2 == 0U) {
    *c4_start_stop_prev = *c4_start_stop;
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 1U, *c4_sfEvent);
    *c4_is_active_c4_mission_server_tracking_qbot2 = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 1U, *c4_sfEvent);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG, 0U, *c4_sfEvent);
    *c4_is_c4_mission_server_tracking_qbot2 = c4_IN_WaitForStartCommand;
    _SFD_CS_CALL(STATE_ACTIVE_TAG, 1U, *c4_sfEvent);
  } else {
    switch (*c4_is_c4_mission_server_tracking_qbot2) {
     ...
     case c4_IN_WaitForStartCommand:
      ...
      if (c4_b_out) {
        ...
        _SFD_CS_CALL(STATE_INACTIVE_TAG, 1U, *c4_sfEvent);
        *c4_is_c4_mission_server_tracking_qbot2 = c4_IN_QbotGetsWaypoints;
        _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, *c4_sfEvent);
      } else {
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY
    (_mission_server_tracking_qbot2MachineNumber_, chartInstance->chartNumber,
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance;
  chartInstance = (SFc4_mission_server_tracking_qbot2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c4_mission_server_tracking_qbot2_get_eml_resolved_functions_info(void)
{
   ...
   *c4_identifier)
{
  ...
  c4_y = c4_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_is_active_c4_mission_server_tracking_qbot2), &c4_thisId);
  sf_mex_destroy(&c4_is_active_c4_mission_server_tracking_qbot2);
  return c4_y;
}
...
void sf_c4_mission_server_tracking_qbot2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_mission_server_tracking_qbot2_get_autoinheritance_info(void)
{
...
mxArray *sf_c4_mission_server_tracking_qbot2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_mission_server_tracking_qbot2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_mission_server_tracking_qbot2
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[13],T\"x_ugv_ref\",},{M[1],M[14],T\"z_ugv_ref\",},{M[8],M[0],T\"is_active_c4_mission_server_tracking_qbot2\",},{M[9],M[0],T\"is_c4_mission_server_tracking_qbot2\",},{M[12],M[16],T\"start_stop_start\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_mission_server_tracking_qbot2_get_check_sum(&mxChecksum);
...
static void sf_check_dwork_consistency(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    mxArray *infoStruct = load_mission_server_tracking_qbot2_optimization_info();
...
static void sf_opaque_initialize_c4_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc4_mission_server_tracking_qbot2InstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc4_mission_server_tracking_qbot2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
  initialize_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  enable_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  disable_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  sf_gateway_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c4_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  ext_mode_exec_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_mission_server_tracking_qbot2
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_mission_server_tracking_qbot2();/* state var info */
...
extern void sf_internal_set_sim_state_c4_mission_server_tracking_qbot2(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_mission_server_tracking_qbot2();/* state var info */
  ...
  set_sim_state_c4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_mission_server_tracking_qbot2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c4_mission_server_tracking_qbot2(S);
}

static void sf_opaque_set_sim_state_c4_mission_server_tracking_qbot2(SimStruct*
  S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_mission_server_tracking_qbot2(S, st);
}

static void sf_opaque_terminate_c4_mission_server_tracking_qbot2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_mission_server_tracking_qbot2InstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_mission_server_tracking_qbot2_optimization_info();
    }

    finalize_c4_mission_server_tracking_qbot2
      ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_mission_server_tracking_qbot2
    ((SFc4_mission_server_tracking_qbot2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_mission_server_tracking_qbot2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_mission_server_tracking_qbot2
      ((SFc4_mission_server_tracking_qbot2InstanceStruct*)
       (chartInfo->chartInstance));
  }
}

mxArray *sf_c4_mission_server_tracking_qbot2_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S1x2'varName','path'{{T\"is_active_c4_mission_server_tracking_qbot2\",T\"is_active_c4_mission_server_tracking_qbot2\"},{T\"is_c4_mission_server_tracking_qbot2\",T\"is_c4_mission_server_tracking_qbot2\"}}"
  };
...
static void mdlSetWorkWidths_c4_mission_server_tracking_qbot2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_mission_server_tracking_qbot2_optimization_info();
...
static void mdlRTW_c4_mission_server_tracking_qbot2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_mission_server_tracking_qbot2(SimStruct *S)
{
  SFc4_mission_server_tracking_qbot2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_mission_server_tracking_qbot2InstanceStruct *)utMalloc
    (sizeof(SFc4_mission_server_tracking_qbot2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_mission_server_tracking_qbot2;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c4_mission_server_tracking_qbot2;
...
void c4_mission_server_tracking_qbot2_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_mission_server_tracking_qbot2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_mission_server_tracking_qbot2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_mission_server_tracking_qbot2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_mission_server_tracking_qbot2_method_dispatcher.\n"
